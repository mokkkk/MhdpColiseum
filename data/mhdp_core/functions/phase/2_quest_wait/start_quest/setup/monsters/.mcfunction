...
# ２匹目
    execute if data storage mh_dp:status GameStatus.Quest.Monsters[1] run say モンスターいます
    execute unless data storage mh_dp:status GameStatus.Quest.Monsters[1] run say モンスターいません
