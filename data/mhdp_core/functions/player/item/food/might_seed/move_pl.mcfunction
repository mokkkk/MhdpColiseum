...
# メインハンド置き換え
    item replace entity @s weapon.mainhand with cookie{display:{Name:'{"text":"怪力の種","color":"green","italic":false}',Lore:['{"text":"--------------------","color":"dark_gray"}','{"text":"食べると力が得られる種．","color":"white","italic":false}','{"text":"一時的に攻撃力が上昇する．","color":"white","italic":false}','{"text":"","color":"white","italic":false}','{"text":"--------------------","color":"dark_gray"}']},MhdpItem:1b,MhdpItemType:3,MhdpItemId:51,CustomModelData:12341,HideFlags:34}
