...
execute store result score #asa_rotation_0 AsaMatrix run data get storage asa_temp: Temp.Rotation[0] 1000
data modify storage math: in set from storage asa_temp: Temp.Rotation[0]
function #math:sin
