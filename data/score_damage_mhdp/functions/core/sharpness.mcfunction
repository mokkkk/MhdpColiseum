#> score_damage_mhdp:core/sharpness
#
# 切れ味更新
...
# 切れ味更新
    execute unless entity @s[tag=KeepSharpness] if score #mhdp_temp_sharp_current MhdpCore matches 3.. run scoreboard players remove #mhdp_temp_sharp_current MhdpCore 3
