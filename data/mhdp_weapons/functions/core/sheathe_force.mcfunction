#> mhdp_weapons:core/sheathe_force
#
...
# オフハンドにアイテムがある場合：アイテムをメインハンドにコピー
    execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].PlayerData.Item.OffHand run function mhdp_weapons:core/sheathe_force_off
