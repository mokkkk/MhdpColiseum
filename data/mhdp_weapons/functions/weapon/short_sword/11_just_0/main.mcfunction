...
# 遷移
    # 右クリック時，ジャストラッシュ２に移行
        execute if entity @s[tag=PlyUsingEyeStart,tag=!PlySneakCurrent,scores={MhdpWeaponTimer=20..70}] run function mhdp_weapons:weapon/short_sword/11_just_0/change_next
