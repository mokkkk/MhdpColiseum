#> mhdp_weapons:weapon/short_sword/2_dash_attack/animation_2
#
# 片手剣：突進斬り アイテムアニメーション
...
# 武器ステータス変更
    ...
    item modify entity @s weapon.mainhand mhdp_core:const/short_sword/no_attack
