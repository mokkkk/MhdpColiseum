#> mhdp_weapons:weapon/short_sword/13_just_2/animation_3
#
...
# 武器ステータス変更
    ...
    # Cmd計算
        ...
        scoreboard players add #mhdp_temp_cmd MhdpCore 47
    ...
    # Cmd計算
        scoreboard players remove #mhdp_temp_cmd MhdpCore 1
        execute store result storage mhdp_core:temp Temp.CustomModelData int 1 run scoreboard players get #mhdp_temp_cmd MhdpCore
    # ダミー用データ
