...
# 移動速度低下
     ...
     execute if entity @s[tag=!SklQuickSheath] run scoreboard players set @s MhdpWeaponDeactivateTimer 8
     # スキル：納刀術
          ...
          execute if entity @s[tag=SklQuickSheath] run scoreboard players set @s MhdpWeaponDeactivateTimer 4
