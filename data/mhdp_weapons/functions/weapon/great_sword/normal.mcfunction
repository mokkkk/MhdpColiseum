...
#declare tag WpnGSwordTacckle 大剣タックル中
...
# 立ち → 右クリック長押し
# 切り上げ → 右クリック長押し
    execute if entity @s[tag=!PlyWeaponDeactivate,tag=IsDrawing,tag=!WpnGswordCharge,tag=!WpnGswordChargeAttack,tag=!WpnGSwordTacckle,tag=!WpnGswordUpper,tag=!PlySneakAvoidFunc,tag=PlyUsingEyeCurrent] run function mhdp_weapons:weapon/great_sword/2_charge/start
