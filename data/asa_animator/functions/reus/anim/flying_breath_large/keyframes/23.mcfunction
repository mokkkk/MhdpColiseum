...
scoreboard players set #asa_child_pos_y AsaMatrix 5039
...
scoreboard players set #asa_child_pos_y AsaMatrix 5489
...
scoreboard players set #asa_child_pos_y AsaMatrix 4501
...
scoreboard players set #asa_child_pos_y AsaMatrix 4440
