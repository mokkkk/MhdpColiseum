...
scoreboard players set #asa_child_pos_y AsaMatrix 4967
...
scoreboard players set #asa_child_pos_y AsaMatrix 5420
...
scoreboard players set #asa_child_pos_y AsaMatrix 2810
