...
scoreboard players set #asa_child_pos_z AsaMatrix 1551
...
scoreboard players set #asa_child_pos_y AsaMatrix 3081
...
scoreboard players set #asa_child_pos_z AsaMatrix 1064
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_y AsaMatrix 4412
...
scoreboard players set #asa_child_pos_y AsaMatrix 3556
