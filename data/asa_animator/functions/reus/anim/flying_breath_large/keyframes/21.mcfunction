...
scoreboard players set #asa_child_pos_y AsaMatrix 4888
...
scoreboard players set #asa_child_pos_y AsaMatrix 5344
...
scoreboard players set #asa_child_pos_y AsaMatrix 4312
...
scoreboard players set #asa_child_pos_y AsaMatrix 3164
...
scoreboard players set #asa_child_pos_z AsaMatrix 1106
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_y AsaMatrix 2787
...
scoreboard players set #asa_child_pos_y AsaMatrix 3693
...
scoreboard players set #asa_child_pos_y AsaMatrix 3574
