...
scoreboard players set #asa_child_pos_y AsaMatrix 3532
...
scoreboard players set #asa_child_pos_y AsaMatrix 2936
...
scoreboard players set #asa_child_pos_y AsaMatrix 3916
