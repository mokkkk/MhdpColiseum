...
scoreboard players set #asa_child_pos_x AsaMatrix 0
scoreboard players set #asa_child_pos_y AsaMatrix 4866
...
scoreboard players set #asa_child_pos_y AsaMatrix 3320
...
scoreboard players set #asa_child_pos_y AsaMatrix 4562
