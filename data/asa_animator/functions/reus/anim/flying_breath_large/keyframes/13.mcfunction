...
scoreboard players set #asa_child_pos_x AsaMatrix 0
scoreboard players set #asa_child_pos_y AsaMatrix 4787
...
data modify storage asa_temp: Data[2].Pose.Head set value [-52.5f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[3].Pose.Head set value [-50f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[16].Pose.Head set value [45f,-15f,-25f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [45f,15f,25f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 2629
scoreboard players set #asa_child_pos_z AsaMatrix 1122
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[18].Pose.Head set value [53f,-12.5f,-47.5f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [53f,12.5f,47.5f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [53f,-12.5f,-47.5f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [53f,12.5f,47.5f]
