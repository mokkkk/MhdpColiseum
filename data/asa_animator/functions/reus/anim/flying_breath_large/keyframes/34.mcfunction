...
scoreboard players set #asa_child_pos_y AsaMatrix 2490
...
scoreboard players set #asa_child_pos_y AsaMatrix 2578
...
scoreboard players set #asa_child_pos_y AsaMatrix 2564
