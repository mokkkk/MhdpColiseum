...
data modify storage asa_temp: Data[11].Pose.Head set value [48f,0f,-10f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [48f,0f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [78f,10f,-30f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [78f,-10f,10f]
