...
data modify storage asa_temp: Data[7].Pose.Head set value [5f,5f,-15f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [10f,5f,-15f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [20f,5f,10f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [80f,0f,-20f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [80f,0f,15f]
