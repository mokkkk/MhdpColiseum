...
data modify storage asa_temp: Data[7].Pose.Head set value [5f,3f,-13f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [-3.999999f,3f,10f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [8f,3f,-13f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [14f,3f,10f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [78f,0f,-16f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [78f,0f,13f]
