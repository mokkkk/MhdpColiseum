...
data modify storage asa_temp: Data[7].Pose.Head set value [37.14286f,1.428571f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [-30f,1.428571f,10f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [14.28571f,-8.571429f,0f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [2.857143f,14.28571f,0f]
...
scoreboard players set #asa_child_pos_x AsaMatrix -3227
