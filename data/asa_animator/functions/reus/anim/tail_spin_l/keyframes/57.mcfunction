...
data modify storage asa_temp: Data[7].Pose.Head set value [31.42857f,-15.71429f,-10f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [2.857141f,-25.71429f,0f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [8.571429f,2.857142f,0f]
...
scoreboard players set #asa_child_pos_x AsaMatrix 4341
