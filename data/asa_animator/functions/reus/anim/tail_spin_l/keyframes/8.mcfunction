...
data modify storage asa_temp: Data[7].Pose.Head set value [26.36364f,-0.9090909f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [-16.36364f,-0.9090909f,10f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [5.454546f,-0.9090909f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [-14.54545f,-0.9090909f,10f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [6.363637f,-10.90909f,0f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [-4.545454f,9.090909f,0f]
...
scoreboard players set #asa_child_pos_x AsaMatrix -3956
