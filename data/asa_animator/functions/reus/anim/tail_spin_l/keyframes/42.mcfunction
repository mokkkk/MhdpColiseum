...
data modify storage asa_temp: Data[7].Pose.Head set value [30f,-25f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [-45f,-20f,15f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [0f,-25f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [-20f,-20f,15f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [5f,-35f,0f]
