...
data modify storage asa_temp: Data[7].Pose.Head set value [38.88889f,-37.77778f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [-38.88889f,-28.88889f,18.88889f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [8.888889f,-37.77778f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [-8.888889f,-28.88889f,18.88889f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [8.888889f,-47.77778f,0f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [1.111111f,0f,8.888889f]
...
scoreboard players set #asa_child_pos_x AsaMatrix 4582
