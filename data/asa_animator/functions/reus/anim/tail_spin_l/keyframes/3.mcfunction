...
data modify storage asa_temp: Data[7].Pose.Head set value [11.66667f,0f,-10f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [5.000001f,0f,-10f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [5.000001f,-10f,0f]
...
scoreboard players set #asa_child_pos_x AsaMatrix 3449
