...
data modify storage asa_temp: Data[7].Pose.Head set value [18.33333f,0f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [-8.333333f,0f,10f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [-1.666667f,10f,0f]
