...
data modify storage asa_temp: Data[7].Pose.Head set value [40f,-40f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [-40f,-30f,20f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [10f,-40f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [-10f,-30f,20f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [10f,-50f,0f]
...
scoreboard players set #asa_child_pos_x AsaMatrix -3946
