...
data modify storage asa_temp: Data[17].Pose.Head set value [50f,-5f,-5f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 2571
scoreboard players set #asa_child_pos_z AsaMatrix 1176
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[18].Pose.Head set value [58f,8.5f,12.5f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [58f,-8.5f,-12.5f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [58f,8.5f,12.5f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [58f,-8.5f,-12.5f]
