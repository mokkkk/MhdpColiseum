...
data modify storage asa_temp: Data[1].Pose.Head set value [38.16667f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[2].Pose.Head set value [5.500003f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[3].Pose.Head set value [-9.666665f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[9].Pose.Head set value [42.91667f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[10].Pose.Head set value [42.91667f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 211
scoreboard players set #asa_child_pos_z AsaMatrix 739
function #asa_matrix:rotate_world
