...
data modify storage asa_temp: Data[0].Pose.Head set value [41.25f,0f,0f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [43.25001f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[3].Pose.Head set value [-5.83333f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[4].Pose.Head set value [-22.91667f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[11].Pose.Head set value [40.83334f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
