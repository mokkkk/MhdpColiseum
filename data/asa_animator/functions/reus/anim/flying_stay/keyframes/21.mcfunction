...
data modify storage asa_temp: Data[1].Pose.Head set value [47.66666f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[3].Pose.Head set value [-4.66667f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[9].Pose.Head set value [58.33333f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[10].Pose.Head set value [65f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 208
scoreboard players set #asa_child_pos_z AsaMatrix 722
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[11].Pose.Head set value [46.66666f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
