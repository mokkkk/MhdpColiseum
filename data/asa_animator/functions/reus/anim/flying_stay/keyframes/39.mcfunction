...
data modify storage asa_temp: Data[1].Pose.Head set value [41.99999f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[2].Pose.Head set value [9.999998f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[3].Pose.Head set value [-6.66667f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
