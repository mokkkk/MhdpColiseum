...
data modify storage asa_temp: Data[0].Pose.Head set value [38.5f,0f,0f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [45.16666f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[2].Pose.Head set value [8.499998f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[3].Pose.Head set value [-7.66667f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[4].Pose.Head set value [-23.83333f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
