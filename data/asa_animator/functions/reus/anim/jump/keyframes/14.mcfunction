...
data modify storage asa_temp: Data[15].Pose.Head set value [1f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[18].Pose.Head set value [86f,4f,26f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [86f,-4f,-26f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [86f,4f,26f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [86f,-4f,-26f]
