...
scoreboard players set #asa_child_pos_z AsaMatrix 6368
...
scoreboard players set #asa_child_pos_z AsaMatrix 6779
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_z AsaMatrix 5815
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[14].Pose.Head set value [-33f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[18].Pose.Head set value [63f,-6f,24f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [63f,6f,-24f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [63f,-6f,24f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [63f,6f,-24f]
