...
scoreboard players set #asa_child_pos_z AsaMatrix 6287
...
data modify storage asa_temp: Data[1].Pose.Head set value [36.5f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
scoreboard players set #asa_child_pos_y AsaMatrix 3146
scoreboard players set #asa_child_pos_z AsaMatrix 6703
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_z AsaMatrix 5744
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[13].Pose.Head set value [-40.5f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[15].Pose.Head set value [-36.5f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[18].Pose.Head set value [63.5f,-4.5f,33f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [63.5f,4.5f,-33f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [63.5f,-4.5f,33f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [63.5f,4.5f,-33f]
