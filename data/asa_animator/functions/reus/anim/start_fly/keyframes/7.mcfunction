...
data modify storage asa_temp: Data[13].Pose.Head set value [-21f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[14].Pose.Head set value [-31f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[18].Pose.Head set value [77f,0f,-28f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [77f,0f,28f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [77f,0f,-28f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [77f,0f,28f]
