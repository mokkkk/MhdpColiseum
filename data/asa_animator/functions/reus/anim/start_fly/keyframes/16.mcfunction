...
data modify storage asa_temp: Data[18].Pose.Head set value [62.5f,-7.5f,15f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [62.5f,7.5f,-15f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [62.5f,-7.5f,15f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [62.5f,7.5f,-15f]
