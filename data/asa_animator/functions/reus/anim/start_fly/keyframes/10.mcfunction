...
scoreboard players set #asa_child_pos_z AsaMatrix 5850
...
scoreboard players set #asa_child_pos_z AsaMatrix 6288
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_z AsaMatrix 5330
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
