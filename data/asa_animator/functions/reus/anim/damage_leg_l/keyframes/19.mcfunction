...
data modify storage asa_temp: Data[16].Pose.Head set value [100f,-7f,15f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [100f,7f,-20f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [94f,-15f,0f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [94f,15f,-5f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [94f,-15f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 6786
...
data modify storage asa_temp: Data[21].Pose.Head set value [94f,15f,-5f]
