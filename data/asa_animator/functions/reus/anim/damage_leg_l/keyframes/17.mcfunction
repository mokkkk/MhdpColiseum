...
data modify storage asa_temp: Data[16].Pose.Head set value [100f,-6f,15f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [100f,6f,-20f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [94f,-14f,0f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [94f,14f,-5f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [94f,-14f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 6765
...
data modify storage asa_temp: Data[21].Pose.Head set value [94f,14f,-5f]
