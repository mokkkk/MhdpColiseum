...
data modify storage asa_temp: Data[16].Pose.Head set value [64f,0f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [64f,0f,10f]
...
scoreboard players set #asa_child_pos_x AsaMatrix 3673
...
scoreboard players set #asa_child_pos_y AsaMatrix 3335
scoreboard players set #asa_child_pos_z AsaMatrix 2928
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
