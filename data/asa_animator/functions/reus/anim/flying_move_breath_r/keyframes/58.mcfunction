...
scoreboard players set #asa_child_pos_z AsaMatrix 3925
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_y AsaMatrix 2562
scoreboard players set #asa_child_pos_z AsaMatrix 1131
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_y AsaMatrix 4708
