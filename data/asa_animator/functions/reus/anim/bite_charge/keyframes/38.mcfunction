...
data modify storage asa_temp: Data[7].Pose.Head set value [-30f,-50f,0f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [10f,0f,0f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [-35f,-50f,0f]
