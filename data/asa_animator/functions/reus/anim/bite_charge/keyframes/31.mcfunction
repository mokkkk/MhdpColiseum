...
data modify storage asa_temp: Data[1].Pose.Head set value [82f,0f,15f]
...
data modify storage asa_temp: Data[7].Pose.Head set value [-70f,15f,-20f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [-10f,15f,-20f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [5f,15f,-10f]
