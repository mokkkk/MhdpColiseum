...
data modify storage asa_temp: Data[7].Pose.Head set value [-30f,-44f,0f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [-2f,-6f,0f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [-29f,-44f,0f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [5f,-6f,0f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [-5f,-44f,0f]
