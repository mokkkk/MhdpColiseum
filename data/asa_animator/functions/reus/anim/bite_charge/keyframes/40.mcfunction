...
data modify storage asa_temp: Data[7].Pose.Head set value [-30f,-48f,0f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [6f,-2f,0f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [-33f,-48f,0f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [5f,-2f,0f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [-5f,-48f,0f]
