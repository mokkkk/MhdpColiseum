...
data modify storage asa_temp: Data[7].Pose.Head set value [-30f,-49f,0f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [8f,-1f,0f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [-34f,-49f,0f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [5f,-1f,0f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [-5f,-49f,0f]
