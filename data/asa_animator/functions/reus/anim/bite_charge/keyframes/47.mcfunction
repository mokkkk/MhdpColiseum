...
data modify storage asa_temp: Data[7].Pose.Head set value [-30f,-41f,0f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [-8.000002f,-9.000001f,0f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [-26f,-41f,0f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [5f,-9.000001f,0f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [-5f,-41f,0f]
