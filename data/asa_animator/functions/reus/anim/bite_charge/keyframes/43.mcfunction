...
data modify storage asa_temp: Data[7].Pose.Head set value [-30f,-45f,0f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [0f,-5f,0f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [-30f,-45f,0f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [5f,-5f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -711
