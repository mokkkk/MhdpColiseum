...
# ターゲット設定
    execute positioned ^ ^1 ^6 run tag @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!ReusParts,tag=!ReiaParts,tag=!Target,distance=0..6.2] add Target
...
# 演出
    execute positioned ^ ^1 ^6 run function asa_animator:reus/anim/bite_charge/events/effect
