...
data modify storage asa_temp: Data[0].Pose.Head set value [-8.4f,0f,0f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [27.6f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[2].Pose.Head set value [9.6f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[9].Pose.Head set value [5f,0f,-2f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [5f,0f,2f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [79f,0f,-2f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [79f,0f,2f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 841
scoreboard players set #asa_child_pos_z AsaMatrix 1625
function #asa_matrix:rotate_world
