...
data modify storage asa_temp: Data[0].Pose.Head set value [-17.2f,0f,0f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [42.8f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[2].Pose.Head set value [8.799999f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[18].Pose.Head set value [77f,0f,-20f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [77f,0f,20f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [77f,0f,-20f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [77f,0f,20f]
