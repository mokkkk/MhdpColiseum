...
data modify storage asa_temp: Data[0].Pose.Head set value [0.8000002f,0f,0f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [18.8f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[2].Pose.Head set value [14.8f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[9].Pose.Head set value [5f,0f,-6f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [5f,0f,6f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [1.999999f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[16].Pose.Head set value [77f,0f,-6f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [77f,0f,6f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 1035
scoreboard players set #asa_child_pos_z AsaMatrix 1676
function #asa_matrix:rotate_world
