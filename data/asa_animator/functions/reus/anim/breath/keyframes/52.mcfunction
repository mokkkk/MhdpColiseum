...
data modify storage asa_temp: Data[0].Pose.Head set value [-1.5f,0f,0f]
...
data modify storage asa_temp: Data[7].Pose.Head set value [12.5f,0f,-5f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [12.5f,0f,5f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 652
scoreboard players set #asa_child_pos_z AsaMatrix -62
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[9].Pose.Head set value [5f,0f,-5f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [5f,0f,5f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [77.5f,0f,-5f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [77.5f,0f,5f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 985
scoreboard players set #asa_child_pos_z AsaMatrix 1666
function #asa_matrix:rotate_world
