...
data modify storage asa_temp: Data[0].Pose.Head set value [-3.8f,0f,0f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [5f,0f,-4f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [5f,0f,4f]
...
data modify storage asa_temp: Data[14].Pose.Head set value [0.9999999f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
scoreboard players set #asa_child_pos_y AsaMatrix 1401
...
data modify storage asa_temp: Data[16].Pose.Head set value [78f,0f,-4f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [78f,0f,4f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 907
scoreboard players set #asa_child_pos_z AsaMatrix 1835
function #asa_matrix:rotate_world
