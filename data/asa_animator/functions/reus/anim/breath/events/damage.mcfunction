...
# ダメージ設定
    ...
    # クエストランクノーマル
        ...
        execute if entity @s[tag=IsAnger] if data storage mh_dp:settings Custom{QuestRank:0} run data modify storage mhdp_core:temp Temp.Damage.Damage set value 15.4f
    # クエストランクハード
