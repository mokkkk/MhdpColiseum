...
data modify storage asa_temp: Data[7].Pose.Head set value [-31f,0f,-2f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [-23f,0f,2f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [65f,0f,-2f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [57f,0f,2f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [9f,-2f,0f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [1f,2f,0f]
...
scoreboard players set #asa_child_pos_x AsaMatrix 4038
