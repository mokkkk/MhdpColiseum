...
data modify storage asa_temp: Data[7].Pose.Head set value [-22f,-9f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [5f,-9f,19f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [32f,-9f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [14f,-9f,19f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [84f,0f,-19f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [84f,0f,28f]
