...
data modify storage asa_temp: Data[7].Pose.Head set value [-6.999999f,-4f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [5f,-4f,14f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [17f,-4f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [9f,-4f,14f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [4.999999f,-14f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [79f,0f,-14f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [79f,0f,18f]
