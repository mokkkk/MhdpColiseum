...
data modify storage asa_temp: Data[7].Pose.Head set value [-13f,-6f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [5f,-6f,16f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [23f,-6f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [11f,-6f,16f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [81f,0f,-16f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [81f,0f,22f]
