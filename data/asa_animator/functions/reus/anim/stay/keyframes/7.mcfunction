...
data modify storage asa_temp: Data[13].Pose.Head set value [6f,-3f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[14].Pose.Head set value [1f,-6f,0f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [2f,-9f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [78f,0f,10f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [78f,0f,-10f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [78f,0f,10f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [78f,0f,-10f]
