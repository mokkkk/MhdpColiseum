...
data modify storage asa_temp: Data[0].Pose.Head set value [-1.907349E-06f,0f,0f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [16.66666f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[13].Pose.Head set value [11.66667f,-1.666667f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[14].Pose.Head set value [6.666667f,-3.333333f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [80f,0f,-16.66667f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [80f,0f,16.66667f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 993
scoreboard players set #asa_child_pos_z AsaMatrix 1666
function #asa_matrix:rotate_world
