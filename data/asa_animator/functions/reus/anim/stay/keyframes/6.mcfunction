...
data modify storage asa_temp: Data[9].Pose.Head set value [2.5f,0f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [2.5f,0f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [0f,-7.5f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [77.5f,0f,-12.5f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [77.5f,0f,12.5f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 1125
scoreboard players set #asa_child_pos_z AsaMatrix 1684
function #asa_matrix:rotate_world
