...
data modify storage asa_temp: Data[13].Pose.Head set value [13.33333f,1.666667f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[14].Pose.Head set value [8.333334f,3.333334f,0f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [13.33333f,1.666667f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [80f,0f,-18.33333f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [80f,0f,18.33333f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 970
scoreboard players set #asa_child_pos_z AsaMatrix 1662
function #asa_matrix:rotate_world
