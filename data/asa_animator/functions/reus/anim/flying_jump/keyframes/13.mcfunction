...
scoreboard players set #asa_child_pos_x AsaMatrix 800
scoreboard players set #asa_child_pos_y AsaMatrix 5253
...
scoreboard players set #asa_child_pos_y AsaMatrix 5660
scoreboard players set #asa_child_pos_z AsaMatrix 689
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_y AsaMatrix 6267
...
scoreboard players set #asa_child_pos_y AsaMatrix 6337
scoreboard players set #asa_child_pos_z AsaMatrix 2273
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
