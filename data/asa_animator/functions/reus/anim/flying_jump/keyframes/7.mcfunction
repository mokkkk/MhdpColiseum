...
data modify storage asa_temp: Data[0].Pose.Head set value [61f,0f,0f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [39f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[16].Pose.Head set value [70f,20f,30f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [70f,-20f,-30f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 3300
scoreboard players set #asa_child_pos_z AsaMatrix 732
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[18].Pose.Head set value [82f,15f,35f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [82f,-15f,-35f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [82f,15f,35f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [82f,-15f,-35f]
