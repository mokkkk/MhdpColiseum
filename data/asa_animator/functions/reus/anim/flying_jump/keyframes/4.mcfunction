...
data modify storage asa_temp: Data[1].Pose.Head set value [54f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[13].Pose.Head set value [-28.5f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[16].Pose.Head set value [60f,5f,5f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [60f,-5f,-5f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 2942
scoreboard players set #asa_child_pos_z AsaMatrix 966
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[18].Pose.Head set value [68f,-1.5f,2.5f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [68f,1.5f,-2.5f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [68f,-1.5f,2.5f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [68f,1.5f,-2.5f]
