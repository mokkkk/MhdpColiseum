...
data modify storage asa_temp: Data[3].Pose.Head set value [-22.5f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[15].Pose.Head set value [19.5f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[16].Pose.Head set value [32.5f,5f,2.5f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [32.5f,-5f,-2.5f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 2855
scoreboard players set #asa_child_pos_z AsaMatrix 787
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[18].Pose.Head set value [41f,1.5f,10f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [41f,-1.5f,-10f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [41f,1.5f,10f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [41f,-1.5f,-10f]
