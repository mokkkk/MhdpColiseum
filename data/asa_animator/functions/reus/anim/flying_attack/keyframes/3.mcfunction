...
data modify storage asa_temp: Data[1].Pose.Head set value [46f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[15].Pose.Head set value [39.75f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[16].Pose.Head set value [57.5f,-2.5f,-8.75f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [57.5f,2.5f,8.75f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 2307
scoreboard players set #asa_child_pos_z AsaMatrix 1375
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[18].Pose.Head set value [62.5f,-8f,-10f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [62.5f,8f,10f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [62.5f,-8f,-10f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [62.5f,8f,10f]
