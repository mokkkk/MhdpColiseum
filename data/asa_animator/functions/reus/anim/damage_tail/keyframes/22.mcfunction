...
scoreboard players set #asa_child_pos_z AsaMatrix 5241
...
scoreboard players set #asa_child_pos_z AsaMatrix 7496
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_z AsaMatrix 8939
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
