...
data modify storage asa_temp: Data[0].Pose.Head set value [1.875f,-2.5f,1.25f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [4.375f,-2.5f,1.25f]
scoreboard players set #asa_child_pos_x AsaMatrix 191
scoreboard players set #asa_child_pos_y AsaMatrix 865
scoreboard players set #asa_child_pos_z AsaMatrix 4898
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[2].Pose.Head set value [11.875f,-2.5f,1.25f]
...
data modify storage asa_temp: Data[3].Pose.Head set value [8.125f,-2.5f,1.25f]
...
data modify storage asa_temp: Data[4].Pose.Head set value [4.375f,-2.5f,1.25f]
...
data modify storage asa_temp: Data[5].Pose.Head set value [5f,-2.5f,1.25f]
...
data modify storage asa_temp: Data[6].Pose.Head set value [-11.25f,-2.5f,0f]
...
data modify storage asa_temp: Data[7].Pose.Head set value [4.375f,-2.5f,-8.75f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [-3.125f,-0.625f,8.75f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [4.375f,-2.5f,-8.75f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [1.875f,-0.625f,8.75f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [4.375f,-11.25f,0f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [-0.625f,8.125f,0f]
...
data modify storage asa_temp: Data[13].Pose.Head set value [-4.375f,-2.5f,0f]
...
data modify storage asa_temp: Data[14].Pose.Head set value [-7.5f,-2.5f,0f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-10.625f,-2.5f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [73.75f,-2.5f,-6.25f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [73.75f,-2.5f,8.75f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [73.75f,-2.5f,11.25f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [73.75f,-2.5f,-8.75f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [73.75f,-2.5f,11.25f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [73.75f,-2.5f,-8.75f]
