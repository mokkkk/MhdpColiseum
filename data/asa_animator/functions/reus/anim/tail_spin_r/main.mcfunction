...
execute if entity @s[scores={AsaMatrix=42}] run function asa_animator:reus/anim/tail_spin_r/keyframes/5
execute if entity @s[scores={AsaMatrix=42..50}] run tp @s ^0 ^0.03333334 ^0 ~-1 ~
execute if entity @s[scores={AsaMatrix=51}] run function asa_animator:reus/anim/tail_spin_r/keyframes/6
execute if entity @s[scores={AsaMatrix=51..57}] run tp @s ^0.1 ^-0.01428571 ^-0.1 ~21 ~
execute if entity @s[scores={AsaMatrix=58}] run function asa_animator:reus/anim/tail_spin_r/keyframes/7
execute if entity @s[scores={AsaMatrix=58..66}] run tp @s ^0.1 ^-0.01111111 ^-0.1 ~7 ~
execute if entity @s[scores={AsaMatrix=67}] run function asa_animator:reus/anim/tail_spin_r/keyframes/8
execute if entity @s[scores={AsaMatrix=67..79}] run tp @s ^0 ^-0.01538462 ^0 ~2 ~
execute if entity @s[scores={AsaMatrix=80}] run function asa_animator:reus/anim/tail_spin_r/keyframes/9
