...
data modify storage asa_temp: Data[8].Pose.Head set value [21.66667f,0f,10f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 650
scoreboard players set #asa_child_pos_z AsaMatrix 20
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[9].Pose.Head set value [-11.66667f,0f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [5.000002f,0f,10f]
