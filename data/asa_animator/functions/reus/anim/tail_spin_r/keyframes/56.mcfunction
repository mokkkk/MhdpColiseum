...
data modify storage asa_temp: Data[8].Pose.Head set value [32.85714f,11.42857f,10f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [7.142858f,-5.714285f,0f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [5.714285f,21.42857f,0f]
...
scoreboard players set #asa_child_pos_x AsaMatrix -4148
