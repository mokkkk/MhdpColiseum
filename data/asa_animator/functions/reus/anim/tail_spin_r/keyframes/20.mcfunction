...
data modify storage asa_temp: Data[7].Pose.Head set value [-30f,12.85714f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [37.14286f,12.85714f,10f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [2.857143f,0f,0f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [14.28571f,22.85714f,0f]
