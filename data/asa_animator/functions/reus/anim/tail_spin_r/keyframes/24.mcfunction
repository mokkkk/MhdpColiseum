...
data modify storage asa_temp: Data[7].Pose.Head set value [-30f,18.57143f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [31.42857f,18.57143f,10f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [8.571429f,0f,0f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [2.857141f,28.57143f,0f]
