...
data modify storage asa_temp: Data[7].Pose.Head set value [-30f,7.142858f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [34.28571f,7.142858f,10f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [5.714286f,-8.571428f,0f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [8.571426f,17.14286f,0f]
