...
data modify storage asa_temp: Data[7].Pose.Head set value [-43.75f,22.5f,-16.25f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [32.5f,28.75f,10f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [-17.5f,22.5f,-16.25f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [2.5f,28.75f,10f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [-7.5f,0f,-6.25f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [6.25f,38.75f,0f]
...
scoreboard players set #asa_child_pos_x AsaMatrix 2552
