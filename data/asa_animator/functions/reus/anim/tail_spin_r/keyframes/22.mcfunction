...
data modify storage asa_temp: Data[7].Pose.Head set value [-30f,15.71429f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [34.28571f,15.71429f,10f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [5.714286f,0f,0f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [8.571426f,25.71429f,0f]
