...
scoreboard players set #asa_child_pos_x AsaMatrix 0
scoreboard players set #asa_child_pos_y AsaMatrix 5183
...
scoreboard players set #asa_child_pos_z AsaMatrix -5831
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_z AsaMatrix -7131
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
