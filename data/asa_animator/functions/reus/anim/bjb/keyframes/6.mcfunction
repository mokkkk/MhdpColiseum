...
data modify storage asa_temp: Data[1].Pose.Head set value [0f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[16].Pose.Head set value [35f,-20f,-20f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [35f,20f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 2237
scoreboard players set #asa_child_pos_z AsaMatrix 1456
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[18].Pose.Head set value [40f,-30f,-30f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [40f,30f,30f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [40f,-30f,-30f]
scoreboard players set #asa_child_pos_x AsaMatrix 2947
scoreboard players set #asa_child_pos_y AsaMatrix 4587
...
data modify storage asa_temp: Data[21].Pose.Head set value [40f,30f,30f]
