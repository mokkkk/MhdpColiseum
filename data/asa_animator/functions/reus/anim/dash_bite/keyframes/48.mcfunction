...
data modify storage asa_temp: Data[13].Pose.Head set value [-1.907349E-06f,-35f,0f]
...
data modify storage asa_temp: Data[14].Pose.Head set value [9.999995f,-50f,0f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [14.99999f,-55f,0f]
