...
execute if entity @s[scores={AsaMatrix=1}] as @a[distance=0..4] run function mhdp_core:player/damage/knockback/wind/1
execute if entity @s[scores={AsaMatrix=1}] as @a[distance=4.1..6] run function mhdp_core:player/damage/knockback/wind/0