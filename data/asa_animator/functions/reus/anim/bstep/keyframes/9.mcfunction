...
scoreboard players set #asa_child_pos_z AsaMatrix -6203
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_z AsaMatrix -7640
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_z AsaMatrix -9293
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
