...
scoreboard players set #asa_child_pos_z AsaMatrix -5664
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_z AsaMatrix -6717
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_z AsaMatrix -9940
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
