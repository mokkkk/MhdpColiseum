...
scoreboard players set #asa_child_pos_y AsaMatrix 2743
...
scoreboard players set #asa_child_pos_y AsaMatrix 3088
...
scoreboard players set #asa_child_pos_y AsaMatrix 3927
scoreboard players set #asa_child_pos_z AsaMatrix 2330
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
