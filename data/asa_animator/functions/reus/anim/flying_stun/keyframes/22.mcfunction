...
data modify storage asa_temp: Data[0].Pose.Head set value [-0.7222223f,38.61111f,-11.88889f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [10.38889f,38.61111f,-11.88889f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-0.1666667f,28.61111f,-31.88889f]
...
data modify storage asa_temp: Data[3].Pose.Head set value [-0.1666665f,19.16667f,-24.88889f]
...
data modify storage asa_temp: Data[4].Pose.Head set value [4.833333f,9.722222f,-14.88889f]
...
data modify storage asa_temp: Data[5].Pose.Head set value [9.833333f,-0.2777778f,0.6666666f]
...
data modify storage asa_temp: Data[6].Pose.Head set value [-0.1666667f,0.2777778f,1.222222f]
...
data modify storage asa_temp: Data[7].Pose.Head set value [68.72222f,0.2777778f,1.222222f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [58.16666f,0.2777778f,2.888889f]
scoreboard players set #asa_child_pos_x AsaMatrix -649
scoreboard players set #asa_child_pos_y AsaMatrix -833
...
data modify storage asa_temp: Data[9].Pose.Head set value [108.1667f,0.2777778f,1.222222f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [98.16666f,0.2777778f,2.888889f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [109.8333f,0.2777778f,1.222222f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [98.72222f,0.2777778f,2.888889f]
...
data modify storage asa_temp: Data[13].Pose.Head set value [-20.44444f,-9.166667f,0.9444444f]
...
data modify storage asa_temp: Data[14].Pose.Head set value [-9.888889f,-17.5f,-0.1666667f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-4.611113f,-25.83333f,-0.1666667f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [99.83334f,-10.27778f,14.55556f]
scoreboard players set #asa_child_pos_x AsaMatrix 963
scoreboard players set #asa_child_pos_y AsaMatrix -411
scoreboard players set #asa_child_pos_z AsaMatrix 1683
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[17].Pose.Head set value [99.83334f,9.166667f,-14.61111f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [93.83334f,-18.27778f,-0.999999f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [93.83334f,16.61111f,0.9444447f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [93.83334f,-18.27778f,-0.9999994f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [93.83334f,16.61111f,0.9444443f]
