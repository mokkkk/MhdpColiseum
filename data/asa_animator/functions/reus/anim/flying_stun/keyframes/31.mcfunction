...
data modify storage asa_temp: Data[0].Pose.Head set value [-7.222222f,26.11111f,-10.88889f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [13.88889f,26.11111f,-10.88889f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-1.666667f,16.11111f,-30.88889f]
...
data modify storage asa_temp: Data[3].Pose.Head set value [-1.666667f,11.66667f,-23.88889f]
...
data modify storage asa_temp: Data[4].Pose.Head set value [3.333333f,7.222222f,-13.88889f]
...
data modify storage asa_temp: Data[5].Pose.Head set value [8.333333f,-2.777778f,6.666667f]
...
data modify storage asa_temp: Data[6].Pose.Head set value [-1.666667f,2.777778f,12.22222f]
...
data modify storage asa_temp: Data[7].Pose.Head set value [57.22222f,2.777778f,12.22222f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [41.66666f,2.777778f,28.88889f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [91.66666f,2.777778f,12.22222f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [81.66666f,2.777778f,28.88889f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [108.3333f,2.777778f,12.22222f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [87.22222f,2.777778f,28.88889f]
...
data modify storage asa_temp: Data[13].Pose.Head set value [-24.44444f,-1.666666f,9.444446f]
...
data modify storage asa_temp: Data[14].Pose.Head set value [-8.888889f,5.000001f,-1.666666f]
scoreboard players set #asa_child_pos_x AsaMatrix 1557
scoreboard players set #asa_child_pos_y AsaMatrix -904
scoreboard players set #asa_child_pos_z AsaMatrix -2660
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[15].Pose.Head set value [-1.111113f,11.66667f,-1.666666f]
scoreboard players set #asa_child_pos_x AsaMatrix 1720
scoreboard players set #asa_child_pos_y AsaMatrix -1178
...
data modify storage asa_temp: Data[16].Pose.Head set value [98.33334f,-12.77778f,10.55556f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [98.33334f,1.666666f,-11.11111f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [92.33334f,-20.77778f,-10f]
scoreboard players set #asa_child_pos_x AsaMatrix 4316
...
data modify storage asa_temp: Data[19].Pose.Head set value [92.33334f,4.111111f,9.444445f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [92.33334f,-20.77778f,-10f]
scoreboard players set #asa_child_pos_x AsaMatrix 5622
...
data modify storage asa_temp: Data[21].Pose.Head set value [92.33334f,4.111111f,9.444445f]
