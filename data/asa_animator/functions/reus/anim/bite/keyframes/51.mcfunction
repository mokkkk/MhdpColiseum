...
data modify storage asa_temp: Data[16].Pose.Head set value [95f,40f,20f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [75f,40f,-20f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [95f,33f,20f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [75f,50f,-20f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [95f,33f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix 894
scoreboard players set #asa_child_pos_y AsaMatrix 669
scoreboard players set #asa_child_pos_z AsaMatrix 6029
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
