...
scoreboard players set #asa_child_pos_y AsaMatrix 4543
...
scoreboard players set #asa_child_pos_y AsaMatrix 4306
...
scoreboard players set #asa_child_pos_y AsaMatrix -3121
...
scoreboard players set #asa_child_pos_y AsaMatrix 3917
...
scoreboard players set #asa_child_pos_y AsaMatrix 4656
scoreboard players set #asa_child_pos_z AsaMatrix 2254
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
