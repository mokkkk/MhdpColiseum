...
scoreboard players set #asa_child_pos_y AsaMatrix 5404
...
scoreboard players set #asa_child_pos_y AsaMatrix 5835
...
scoreboard players set #asa_child_pos_y AsaMatrix 4858
...
scoreboard players set #asa_child_pos_y AsaMatrix 4226
