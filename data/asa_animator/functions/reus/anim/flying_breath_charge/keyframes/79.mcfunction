...
scoreboard players set #asa_child_pos_y AsaMatrix 3210
...
scoreboard players set #asa_child_pos_y AsaMatrix 4594
...
scoreboard players set #asa_child_pos_y AsaMatrix 4671
scoreboard players set #asa_child_pos_z AsaMatrix 1962
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
