...
scoreboard players set #asa_child_pos_y AsaMatrix 5502
...
scoreboard players set #asa_child_pos_y AsaMatrix 5959
scoreboard players set #asa_child_pos_z AsaMatrix -77
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_y AsaMatrix 4879
...
scoreboard players set #asa_child_pos_x AsaMatrix -295
scoreboard players set #asa_child_pos_y AsaMatrix 4227
...
scoreboard players set #asa_child_pos_y AsaMatrix 4903
