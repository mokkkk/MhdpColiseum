...
data modify storage asa_temp: Data[19].Pose.Head set value [80f,4.666666f,-16.66667f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [80f,4.666666f,-16.66667f]
