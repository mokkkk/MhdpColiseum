...
data modify storage asa_temp: Data[14].Pose.Head set value [30f,-30f,0f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [60f,-45f,0f]
...
scoreboard players set #asa_child_pos_y AsaMatrix 2846
...
data modify storage asa_temp: Data[19].Pose.Head set value [80f,-2f,-50f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [80f,-2f,-50f]
