...
scoreboard players set #asa_child_pos_x AsaMatrix -1300
scoreboard players set #asa_child_pos_y AsaMatrix 3963
...
data modify storage asa_temp: Data[14].Pose.Head set value [35f,-30f,0f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [65f,-45f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -2424
scoreboard players set #asa_child_pos_y AsaMatrix 4076
scoreboard players set #asa_child_pos_z AsaMatrix -5297
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [80f,-10f,0f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [80f,8f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -4033
scoreboard players set #asa_child_pos_y AsaMatrix 3807
scoreboard players set #asa_child_pos_z AsaMatrix -141
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[20].Pose.Head set value [80f,-10f,0f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [80f,8f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -5045
scoreboard players set #asa_child_pos_y AsaMatrix 4084
