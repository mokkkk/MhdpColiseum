...
scoreboard players set #asa_child_pos_y AsaMatrix 4130
...
scoreboard players set #asa_child_pos_y AsaMatrix 4438
...
scoreboard players set #asa_child_pos_y AsaMatrix 3520
