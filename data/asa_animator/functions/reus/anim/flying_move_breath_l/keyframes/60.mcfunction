...
scoreboard players set #asa_child_pos_y AsaMatrix 2489
...
scoreboard players set #asa_child_pos_y AsaMatrix 4700
...
scoreboard players set #asa_child_pos_y AsaMatrix 4605
scoreboard players set #asa_child_pos_z AsaMatrix 1516
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
