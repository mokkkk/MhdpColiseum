...
# 演出
    execute if entity @s[tag=DestroyTail] run particle cloud ^ ^1.3 ^5 0.1 0.1 0.1 0.1 3
    execute if entity @s[tag=DestroyTail] run particle cloud ^-1.6 ^1 ^5 0.1 0.1 0.1 0.1 3
    execute if entity @s[tag=!DestroyTail] run particle cloud ^ ^1.3 ^7 0.1 0.1 0.1 0.1 3
    execute if entity @s[tag=!DestroyTail] run particle cloud ^-1.6 ^1 ^7 0.1 0.1 0.1 0.1 3
