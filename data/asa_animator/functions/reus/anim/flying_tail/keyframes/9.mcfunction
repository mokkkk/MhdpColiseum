...
data modify storage asa_temp: Data[1].Pose.Head set value [117f,0f,10f]
...
scoreboard players set #asa_child_pos_y AsaMatrix 4014
...
data modify storage asa_temp: Data[14].Pose.Head set value [-70f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[15].Pose.Head set value [-90f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
scoreboard players set #asa_child_pos_y AsaMatrix 3931
