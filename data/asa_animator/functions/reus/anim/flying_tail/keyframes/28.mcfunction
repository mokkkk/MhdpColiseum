...
data modify storage asa_temp: Data[1].Pose.Head set value [48f,0f,5f]
...
scoreboard players set #asa_child_pos_y AsaMatrix 4870
...
scoreboard players set #asa_child_pos_x AsaMatrix 281
scoreboard players set #asa_child_pos_y AsaMatrix 4655
...
data modify storage asa_temp: Data[7].Pose.Head set value [-92.5f,15f,0f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [-70f,22.5f,0f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [-70f,15f,0f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [-42.5f,22.5f,0f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [-52.5f,15f,0f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [-30f,22.5f,0f]
...
data modify storage asa_temp: Data[13].Pose.Head set value [-149.5f,17.5f,0f]
...
data modify storage asa_temp: Data[14].Pose.Head set value [-168.5f,29.5f,22.5f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-158.5f,39.5f,35f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [12f,-22.5f,-20f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [7f,20f,20f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [11f,-40.5f,-7.5f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [1f,30.5f,2.5f]
scoreboard players set #asa_child_pos_x AsaMatrix -2308
scoreboard players set #asa_child_pos_y AsaMatrix 4366
...
data modify storage asa_temp: Data[20].Pose.Head set value [11f,-40.5f,-7.5f]
scoreboard players set #asa_child_pos_x AsaMatrix 3256
scoreboard players set #asa_child_pos_y AsaMatrix 5879
...
data modify storage asa_temp: Data[21].Pose.Head set value [1f,30.5f,2.5f]
scoreboard players set #asa_child_pos_x AsaMatrix -2941
scoreboard players set #asa_child_pos_y AsaMatrix 5995
