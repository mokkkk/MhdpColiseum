...
scoreboard players set #asa_child_pos_y AsaMatrix 4033
...
scoreboard players set #asa_child_pos_y AsaMatrix 5149
...
scoreboard players set #asa_child_pos_y AsaMatrix 5312
