...
data modify storage asa_temp: Data[0].Pose.Head set value [32.60001f,0f,0f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [39.40001f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[2].Pose.Head set value [8.600001f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[4].Pose.Head set value [-17.8f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[10].Pose.Head set value [61f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 1045
scoreboard players set #asa_child_pos_z AsaMatrix 703
function #asa_matrix:rotate_world
