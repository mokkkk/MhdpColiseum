...
scoreboard players set #asa_child_pos_y AsaMatrix 3774
...
scoreboard players set #asa_child_pos_y AsaMatrix 3882
...
scoreboard players set #asa_child_pos_y AsaMatrix 5314
