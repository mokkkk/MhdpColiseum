...
scoreboard players set #asa_child_pos_y AsaMatrix 4532
...
scoreboard players set #asa_child_pos_y AsaMatrix 4802
...
scoreboard players set #asa_child_pos_y AsaMatrix 6041
