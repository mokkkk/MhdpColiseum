...
data modify storage asa_temp: Data[0].Pose.Head set value [31.8f,0f,0f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [9.800001f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[3].Pose.Head set value [1.199999f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[4].Pose.Head set value [-15.4f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[9].Pose.Head set value [68f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[10].Pose.Head set value [68f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 204
scoreboard players set #asa_child_pos_z AsaMatrix 689
function #asa_matrix:rotate_world
