...
data modify storage asa_temp: Data[0].Pose.Head set value [18f,8f,0f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [18f,8f,0f]
...
data modify storage asa_temp: Data[3].Pose.Head set value [23f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[14].Pose.Head set value [-1f,16f,0f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-6f,32f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [79f,0f,2f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [79f,0f,-2f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [79f,0f,2f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [79f,0f,-2f]
