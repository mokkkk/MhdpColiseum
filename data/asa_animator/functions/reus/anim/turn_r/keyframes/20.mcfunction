...
data modify storage asa_temp: Data[0].Pose.Head set value [20f,2f,0f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [20f,2f,0f]
...
data modify storage asa_temp: Data[13].Pose.Head set value [5f,2f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[15].Pose.Head set value [-5f,8f,0f]
