...
data modify storage asa_temp: Data[10].Pose.Head set value [0f,0f,10f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [-10f,-10f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [80f,0f,0f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [80f,0f,0f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [80f,0f,0f]
