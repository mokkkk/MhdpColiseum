...
data modify storage asa_temp: Data[16].Pose.Head set value [80f,0f,-14f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [80f,0f,14f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 1087
scoreboard players set #asa_child_pos_z AsaMatrix 1675
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[18].Pose.Head set value [80f,0f,6f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [80f,0f,-6f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [80f,0f,6f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [80f,0f,-6f]
