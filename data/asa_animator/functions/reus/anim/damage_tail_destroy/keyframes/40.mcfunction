...
scoreboard players set #asa_child_pos_x AsaMatrix -1955
...
scoreboard players set #asa_child_pos_x AsaMatrix -4169
...
scoreboard players set #asa_child_pos_x AsaMatrix -5580
