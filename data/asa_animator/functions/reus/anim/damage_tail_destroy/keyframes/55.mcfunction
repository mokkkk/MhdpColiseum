...
scoreboard players set #asa_child_pos_y AsaMatrix 1627
...
scoreboard players set #asa_child_pos_y AsaMatrix 1453
...
scoreboard players set #asa_child_pos_x AsaMatrix -4453
