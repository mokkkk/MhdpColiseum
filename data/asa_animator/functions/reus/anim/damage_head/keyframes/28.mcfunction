...
scoreboard players set #asa_child_pos_z AsaMatrix -5047
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_z AsaMatrix -6498
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
scoreboard players set #asa_child_pos_z AsaMatrix -8229
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
