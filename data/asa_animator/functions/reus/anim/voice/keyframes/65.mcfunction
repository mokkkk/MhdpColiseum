...
data modify storage asa_temp: Data[1].Pose.Head set value [11.2f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[7].Pose.Head set value [2f,0f,-4f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [2f,0f,4f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 651
scoreboard players set #asa_child_pos_z AsaMatrix 48
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[9].Pose.Head set value [11f,0f,-4f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [11f,0f,4f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [75f,0f,16f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [75f,0f,-16f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [75f,0f,16f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [75f,0f,-16f]
