...
data modify storage asa_temp: Data[1].Pose.Head set value [65f,0f,5f]
...
data modify storage asa_temp: Data[6].Pose.Head set value [0f,0f,5f]
...
data modify storage asa_temp: Data[13].Pose.Head set value [10f,5f,5f]
scoreboard players set #asa_child_pos_x AsaMatrix -9
scoreboard players set #asa_child_pos_y AsaMatrix 1350
...
data modify storage asa_temp: Data[14].Pose.Head set value [15f,10f,5f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [20f,10f,5f]
scoreboard players set #asa_child_pos_x AsaMatrix 483
scoreboard players set #asa_child_pos_y AsaMatrix 2036
scoreboard players set #asa_child_pos_z AsaMatrix -5184
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[16].Pose.Head set value [50f,0f,-20f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [50f,0f,20f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [50f,-15f,-40f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [50f,15f,40f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [50f,-15f,-40f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [50f,15f,40f]
