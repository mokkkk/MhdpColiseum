...
scoreboard players set #asa_child_pos_z AsaMatrix 5450
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[16].Pose.Head set value [70f,0f,10f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [70f,0f,-10f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 871
scoreboard players set #asa_child_pos_z AsaMatrix 2496
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[18].Pose.Head set value [70f,0f,25f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [70f,0f,25f]
