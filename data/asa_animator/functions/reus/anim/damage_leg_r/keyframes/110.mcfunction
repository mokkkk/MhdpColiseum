...
scoreboard players set #asa_child_pos_x AsaMatrix -3170
...
scoreboard players set #asa_child_pos_x AsaMatrix -3742
...
scoreboard players set #asa_child_pos_x AsaMatrix -5628
