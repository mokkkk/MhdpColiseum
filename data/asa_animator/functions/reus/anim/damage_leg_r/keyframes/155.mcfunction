...
data modify storage asa_temp: Data[7].Pose.Head set value [-25.33333f,0f,-1.333333f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [-34f,0f,1.333333f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [61.33333f,0f,-1.333333f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [70f,0f,1.333333f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [0.6666641f,-1.333333f,0f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [9.333324f,1.333333f,0f]
...
scoreboard players set #asa_child_pos_x AsaMatrix -4120
...
scoreboard players set #asa_child_pos_x AsaMatrix -6767
scoreboard players set #asa_child_pos_y AsaMatrix 636
scoreboard players set #asa_child_pos_z AsaMatrix 2923
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
