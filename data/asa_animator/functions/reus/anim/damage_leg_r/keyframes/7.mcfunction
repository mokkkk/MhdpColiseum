...
scoreboard players set #asa_child_pos_y AsaMatrix 1682
...
scoreboard players set #asa_child_pos_x AsaMatrix 2540
...
scoreboard players set #asa_child_pos_y AsaMatrix 3529
