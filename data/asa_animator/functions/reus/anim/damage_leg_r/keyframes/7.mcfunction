...
data modify storage asa_temp: Data[0].Pose.Head set value [-22.22222f,-43.33333f,17.77778f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [27.77778f,-43.33333f,17.77778f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-8.888889f,-40f,27.77778f]
...
data modify storage asa_temp: Data[3].Pose.Head set value [-20f,-17.77778f,22.77778f]
scoreboard players set #asa_child_pos_x AsaMatrix -1641
scoreboard players set #asa_child_pos_y AsaMatrix 1311
scoreboard players set #asa_child_pos_z AsaMatrix 2929
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[4].Pose.Head set value [-19.44444f,-3.333333f,8.333334f]
...
data modify storage asa_temp: Data[5].Pose.Head set value [-7.777778f,0f,-10f]
scoreboard players set #asa_child_pos_x AsaMatrix -1684
...
data modify storage asa_temp: Data[6].Pose.Head set value [-13.33333f,0f,-11.11111f]
...
data modify storage asa_temp: Data[7].Pose.Head set value [26.66667f,0f,-36.66666f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [-30f,0f,-6.666666f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [48.88889f,0f,-36.66666f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [-7.777779f,0f,-6.666666f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [31.11111f,-4.444445f,-23.33333f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [-7.777778f,4.444445f,-11.11111f]
...
data modify storage asa_temp: Data[13].Pose.Head set value [-20.55556f,6.666667f,-10.55556f]
...
data modify storage asa_temp: Data[14].Pose.Head set value [-8.333333f,12.22222f,-9.444445f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [10.55556f,15.55555f,-9.444444f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [62.22222f,-5f,-22.22222f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [71.11111f,5f,-3.888889f]
scoreboard players set #asa_child_pos_x AsaMatrix -2493
...
data modify storage asa_temp: Data[18].Pose.Head set value [58.88889f,-0.5555553f,-21.66667f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [67.77777f,0.5555553f,13.33333f]
scoreboard players set #asa_child_pos_x AsaMatrix -4438
scoreboard players set #asa_child_pos_y AsaMatrix 918
scoreboard players set #asa_child_pos_z AsaMatrix 1589
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[20].Pose.Head set value [58.88889f,-0.5555553f,-21.66667f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [67.77777f,0.5555553f,13.33333f]
scoreboard players set #asa_child_pos_x AsaMatrix -5091
scoreboard players set #asa_child_pos_y AsaMatrix 1694
