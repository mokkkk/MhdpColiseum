...
data modify storage asa_temp: Data[1].Pose.Head set value [73f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[4].Pose.Head set value [27f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[15].Pose.Head set value [49f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[18].Pose.Head set value [85f,20f,35f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [85f,-20f,-35f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [85f,20f,35f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [85f,-20f,-35f]
