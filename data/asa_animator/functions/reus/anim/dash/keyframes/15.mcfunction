...
data modify storage asa_temp: Data[9].Pose.Head set value [-36f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[10].Pose.Head set value [38f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 232
...
data modify storage asa_temp: Data[11].Pose.Head set value [-27f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[12].Pose.Head set value [56f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
