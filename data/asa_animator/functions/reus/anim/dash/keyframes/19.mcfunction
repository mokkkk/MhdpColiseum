...
data modify storage asa_temp: Data[9].Pose.Head set value [-24f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[11].Pose.Head set value [-14f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[12].Pose.Head set value [31f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
