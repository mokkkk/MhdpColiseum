...
data modify storage asa_temp: Data[7].Pose.Head set value [6f,0f,0f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [-6f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 665
scoreboard players set #asa_child_pos_z AsaMatrix -146
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[9].Pose.Head set value [14f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[10].Pose.Head set value [-18f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix -131
...
data modify storage asa_temp: Data[11].Pose.Head set value [28f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[12].Pose.Head set value [-11f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
