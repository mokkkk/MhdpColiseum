...
data modify storage asa_temp: Data[1].Pose.Head set value [62f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
scoreboard players set #asa_child_pos_x AsaMatrix 0
scoreboard players set #asa_child_pos_y AsaMatrix 2674
...
data modify storage asa_temp: Data[16].Pose.Head set value [60f,-10f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [60f,10f,5f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 2397
scoreboard players set #asa_child_pos_z AsaMatrix 1320
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[18].Pose.Head set value [64f,-8f,10f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [64f,8f,-5f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [64f,-8f,10f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [64f,8f,-5f]
