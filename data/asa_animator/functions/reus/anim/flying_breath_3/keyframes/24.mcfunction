...
data modify storage asa_temp: Data[1].Pose.Head set value [75f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[16].Pose.Head set value [50f,20f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[17].Pose.Head set value [50f,-20f,-10f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 2798
scoreboard players set #asa_child_pos_z AsaMatrix -74
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[18].Pose.Head set value [60f,30f,25f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [60f,-30f,-35f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [60f,30f,25f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [60f,-30f,-35f]
