...
scoreboard players set #asa_child_pos_y AsaMatrix 4041
...
scoreboard players set #asa_child_pos_x AsaMatrix 0
scoreboard players set #asa_child_pos_y AsaMatrix 4474
...
scoreboard players set #asa_child_pos_y AsaMatrix 5976
...
scoreboard players set #asa_child_pos_y AsaMatrix 5967
