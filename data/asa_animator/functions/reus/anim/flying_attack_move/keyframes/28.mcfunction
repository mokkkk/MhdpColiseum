...
scoreboard players set #asa_child_pos_x AsaMatrix 0
scoreboard players set #asa_child_pos_y AsaMatrix 4473
...
scoreboard players set #asa_child_pos_x AsaMatrix 0
scoreboard players set #asa_child_pos_y AsaMatrix 4901
...
scoreboard players set #asa_child_pos_x AsaMatrix 2568
scoreboard players set #asa_child_pos_y AsaMatrix 6113
