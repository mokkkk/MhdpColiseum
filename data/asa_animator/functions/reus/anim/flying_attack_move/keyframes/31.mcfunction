...
scoreboard players set #asa_child_pos_x AsaMatrix 0
scoreboard players set #asa_child_pos_y AsaMatrix 4549
...
scoreboard players set #asa_child_pos_y AsaMatrix 6071
...
scoreboard players set #asa_child_pos_x AsaMatrix -2630
scoreboard players set #asa_child_pos_y AsaMatrix 6070
