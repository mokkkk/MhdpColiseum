...
scoreboard players set #asa_child_pos_y AsaMatrix 4233
...
scoreboard players set #asa_child_pos_y AsaMatrix 4003
...
scoreboard players set #asa_child_pos_y AsaMatrix 5301
...
scoreboard players set #asa_child_pos_y AsaMatrix 5266
