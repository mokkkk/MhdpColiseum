...
scoreboard players set #asa_child_pos_y AsaMatrix 4851
...
scoreboard players set #asa_child_pos_y AsaMatrix 5285
...
scoreboard players set #asa_child_pos_y AsaMatrix 3711
