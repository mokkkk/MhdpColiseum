...
scoreboard players set #asa_child_pos_y AsaMatrix 5573
...
scoreboard players set #asa_child_pos_y AsaMatrix 4900
...
scoreboard players set #asa_child_pos_y AsaMatrix 6439
