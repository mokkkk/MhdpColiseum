...
data modify storage asa_temp: Data[0].Pose.Head set value [4f,24f,-9.6f]
...
data modify storage asa_temp: Data[7].Pose.Head set value [48f,0f,0f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [42f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 650
scoreboard players set #asa_child_pos_z AsaMatrix 0
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[9].Pose.Head set value [104f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 800
...
data modify storage asa_temp: Data[10].Pose.Head set value [94f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -800
...
data modify storage asa_temp: Data[13].Pose.Head set value [-18f,-5f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
scoreboard players set #asa_child_pos_y AsaMatrix 1250
...
data modify storage asa_temp: Data[15].Pose.Head set value [-4f,-15f,0f]
