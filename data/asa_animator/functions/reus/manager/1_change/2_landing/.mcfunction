...
# 近
    execute if predicate asa_animator:reus/stay if entity @e[tag=ReusAttackTarget,distance=..10] run function asa_animator:reus/manager/1_change/2_landing/near
