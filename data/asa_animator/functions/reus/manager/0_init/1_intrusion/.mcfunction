#> asa_animator:reus/manager/0_init/1_intrusion/
#
# 火竜 乱入処理
...
# 召喚処理 
    execute if data storage mhdp: {ExistMonster:0b} run function asa_animator:reus/manager/0_init/1_intrusion/summon
