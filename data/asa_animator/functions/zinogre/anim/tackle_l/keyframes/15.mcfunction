...
data modify storage asa_temp: Data[0].Pose.Head set value [-7.5f,-37.5f,22.5f]
scoreboard players set #asa_child_pos_x AsaMatrix 479
scoreboard players set #asa_child_pos_y AsaMatrix 2389
...
data modify storage asa_temp: Data[1].Pose.Head set value [7.5f,-37.5f,22.5f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [2.5f,-22.5f,22.5f]
scoreboard players set #asa_child_pos_x AsaMatrix 373
scoreboard players set #asa_child_pos_y AsaMatrix 2675
...
data modify storage asa_temp: Data[3].Pose.Head set value [7.5f,-15f,22.5f]
scoreboard players set #asa_child_pos_x AsaMatrix 279
scoreboard players set #asa_child_pos_y AsaMatrix 2785
scoreboard players set #asa_child_pos_z AsaMatrix 4255
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[4].Pose.Head set value [-2.5f,-7.5f,22.5f]
scoreboard players set #asa_child_pos_x AsaMatrix 257
scoreboard players set #asa_child_pos_y AsaMatrix 2834
...
data modify storage asa_temp: Data[5].Pose.Head set value [12.5f,0f,22.5f]
...
data modify storage asa_temp: Data[7].Pose.Head set value [-20f,15f,-37.5f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [10f,15f,32.5f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [80f,22.5f,-37.5f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [80f,15f,32.5f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [0f,0f,-30f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [-11.25f,15f,25f]
...
data modify storage asa_temp: Data[14].Pose.Head set value [-3.75f,15f,0f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-30f,-7.5f,15f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-10f,5f,15f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [15f,17.5f,15f]
scoreboard players set #asa_child_pos_x AsaMatrix 165
scoreboard players set #asa_child_pos_y AsaMatrix 222
scoreboard players set #asa_child_pos_z AsaMatrix -3927
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [37.5f,20f,15f]
scoreboard players set #asa_child_pos_x AsaMatrix 808
scoreboard players set #asa_child_pos_y AsaMatrix 719
scoreboard players set #asa_child_pos_z AsaMatrix -5490
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[19].Pose.Head set value [105f,10f,-52.5f]
scoreboard players set #asa_child_pos_x AsaMatrix 821
...
data modify storage asa_temp: Data[20].Pose.Head set value [112.5f,-32.5f,30f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [20f,-30f,32.5f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [68.75f,17.5f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -2681
...
data modify storage asa_temp: Data[23].Pose.Head set value [-5f,-35f,15f]
scoreboard players set #asa_child_pos_x AsaMatrix 3244
...
data modify storage asa_temp: Data[24].Pose.Head set value [-5f,22.5f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -3006
