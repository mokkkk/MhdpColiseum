...
data modify storage asa_temp: Data[20].Pose.Head set value [60f,-70f,60f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [55f,-20f,5f]
...
data modify storage asa_temp: Data[23].Pose.Head set value [-2f,-25f,0f]
