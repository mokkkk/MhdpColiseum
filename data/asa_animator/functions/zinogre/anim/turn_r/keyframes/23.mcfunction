...
data modify storage asa_temp: Data[19].Pose.Head set value [120f,12.5f,-35f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [115f,-7.5f,30f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [75f,-12.5f,0f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [62.5f,2.5f,0f]
