...
data modify storage asa_temp: Data[8].Pose.Head set value [0f,0f,10f]
scoreboard players set #asa_child_pos_x AsaMatrix -1100
scoreboard players set #asa_child_pos_y AsaMatrix 699
scoreboard players set #asa_child_pos_z AsaMatrix -100
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[12].Pose.Head set value [40f,0f,10f]
...
data modify storage asa_temp: Data[14].Pose.Head set value [40f,0f,0f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [105f,15f,-30f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [115f,-5f,30f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [45f,5f,0f]
...
data modify storage asa_temp: Data[24].Pose.Head set value [5f,10f,0f]
