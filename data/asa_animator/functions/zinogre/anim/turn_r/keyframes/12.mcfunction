...
data modify storage asa_temp: Data[0].Pose.Head set value [20f,25f,-5f]
scoreboard players set #asa_child_pos_x AsaMatrix -512
scoreboard players set #asa_child_pos_y AsaMatrix 3120
...
data modify storage asa_temp: Data[1].Pose.Head set value [20f,25f,-5f]
scoreboard players set #asa_child_pos_x AsaMatrix -460
scoreboard players set #asa_child_pos_y AsaMatrix 3336
...
data modify storage asa_temp: Data[2].Pose.Head set value [10f,17.5f,-5f]
...
data modify storage asa_temp: Data[3].Pose.Head set value [5f,7.5f,-5f]
...
data modify storage asa_temp: Data[5].Pose.Head set value [0f,7.5f,0f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [77.5f,0f,10f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [0f,20f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [15f,35f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 672
scoreboard players set #asa_child_pos_y AsaMatrix 207
scoreboard players set #asa_child_pos_z AsaMatrix -5586
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[19].Pose.Head set value [110f,17.5f,-60f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [105f,-2.5f,25f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [75f,-22.5f,0f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [56.25f,7.5f,0f]
...
data modify storage asa_temp: Data[23].Pose.Head set value [15f,-27.5f,0f]
