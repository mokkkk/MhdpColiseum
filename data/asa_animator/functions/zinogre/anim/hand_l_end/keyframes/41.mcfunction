...
data modify storage asa_temp: Data[8].Pose.Head set value [6f,0f,10f]
scoreboard players set #asa_child_pos_x AsaMatrix -1100
scoreboard players set #asa_child_pos_y AsaMatrix 701
scoreboard players set #asa_child_pos_z AsaMatrix -106
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[9].Pose.Head set value [84f,0f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [76f,0f,10f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [120f,10f,-30f]
scoreboard players set #asa_child_pos_x AsaMatrix 1100
...
data modify storage asa_temp: Data[21].Pose.Head set value [54f,0f,0f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [66f,0f,0f]
...
data modify storage asa_temp: Data[23].Pose.Head set value [4f,-5f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 2465
