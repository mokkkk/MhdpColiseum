...
data modify storage asa_temp: Data[7].Pose.Head set value [8f,0f,-10f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [78f,0f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [82f,0f,10f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [115f,-10f,30f]
scoreboard players set #asa_child_pos_x AsaMatrix -1100
scoreboard players set #asa_child_pos_y AsaMatrix 2040
scoreboard players set #asa_child_pos_z AsaMatrix 2270
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[21].Pose.Head set value [68f,0f,0f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [62f,0f,0f]
