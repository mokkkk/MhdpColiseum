...
data modify storage asa_temp: Data[7].Pose.Head set value [9f,0f,-10f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [79f,0f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [81f,0f,10f]
scoreboard players set #asa_child_pos_x AsaMatrix -1234
...
data modify storage asa_temp: Data[20].Pose.Head set value [112.5f,-10f,30f]
scoreboard players set #asa_child_pos_x AsaMatrix -1100
scoreboard players set #asa_child_pos_y AsaMatrix 2062
scoreboard players set #asa_child_pos_z AsaMatrix 2257
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[21].Pose.Head set value [69f,0f,0f]
