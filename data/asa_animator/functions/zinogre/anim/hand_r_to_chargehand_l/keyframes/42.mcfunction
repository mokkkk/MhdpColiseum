...
data modify storage asa_temp: Data[7].Pose.Head set value [-12.5f,27.5f,-15f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [28.75f,-2.5f,10f]
...
data modify storage asa_temp: Data[13].Pose.Head set value [12.5f,20f,-5f]
...
scoreboard players set #asa_child_pos_x AsaMatrix -1322
