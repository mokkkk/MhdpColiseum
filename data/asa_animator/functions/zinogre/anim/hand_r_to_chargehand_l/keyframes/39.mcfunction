...
data modify storage asa_temp: Data[7].Pose.Head set value [-50f,-10f,-30f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [40f,-10f,-30f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [-10f,-10f,-30f]
...
data modify storage asa_temp: Data[13].Pose.Head set value [10f,-10f,-20f]
