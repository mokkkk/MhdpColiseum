...
data modify storage asa_temp: Data[7].Pose.Head set value [7f,0f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [13f,0f,10f]
scoreboard players set #asa_child_pos_x AsaMatrix -1100
scoreboard players set #asa_child_pos_y AsaMatrix 701
scoreboard players set #asa_child_pos_z AsaMatrix -104
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[9].Pose.Head set value [77f,0f,-10f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [117.5f,-10f,30f]
scoreboard players set #asa_child_pos_x AsaMatrix -1100
scoreboard players set #asa_child_pos_y AsaMatrix 2017
scoreboard players set #asa_child_pos_z AsaMatrix 2283
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[21].Pose.Head set value [67f,0f,0f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [58f,0f,0f]
...
data modify storage asa_temp: Data[24].Pose.Head set value [3f,5f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -2470
