...
scoreboard players set #asa_child_pos_x AsaMatrix 4345
...
data modify storage asa_temp: Data[19].Pose.Head set value [120f,50f,-50f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [160f,30f,40f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [105f,80f,20f]
...
data modify storage asa_temp: Data[24].Pose.Head set value [30f,85f,20f]
