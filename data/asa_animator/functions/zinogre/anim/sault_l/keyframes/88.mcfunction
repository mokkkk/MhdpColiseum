...
scoreboard players set #asa_child_pos_x AsaMatrix -1094
...
scoreboard players set #asa_child_pos_x AsaMatrix -2221
...
scoreboard players set #asa_child_pos_x AsaMatrix -3695
