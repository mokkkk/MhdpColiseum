...
scoreboard players set #asa_child_pos_x AsaMatrix -4880
...
data modify storage asa_temp: Data[19].Pose.Head set value [122.5f,-31.625f,-35f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [94.375f,-51.5f,50f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [72.25f,-87.25f,-15f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [34.375f,-1.5f,10f]
...
data modify storage asa_temp: Data[23].Pose.Head set value [7.625f,-92.25f,-10f]
scoreboard players set #asa_child_pos_x AsaMatrix 4739
