...
data modify storage asa_temp: Data[8].Pose.Head set value [2.5f,-27.5f,15f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [23.75f,2.5f,-10f]
...
data modify storage asa_temp: Data[14].Pose.Head set value [2.5f,-20f,5f]
