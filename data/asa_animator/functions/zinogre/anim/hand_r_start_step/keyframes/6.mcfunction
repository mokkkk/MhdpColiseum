...
data modify storage asa_temp: Data[19].Pose.Head set value [135f,10f,-36.25f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [116.25f,-28.75f,30f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [88.75f,0f,-6.25f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [57.5f,6.25f,0f]
...
data modify storage asa_temp: Data[23].Pose.Head set value [18.75f,-5f,-6.25f]
