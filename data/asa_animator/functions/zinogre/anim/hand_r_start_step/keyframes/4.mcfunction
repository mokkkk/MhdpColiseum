...
data modify storage asa_temp: Data[19].Pose.Head set value [125f,10f,-33.75f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [113.75f,-21.25f,30f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [81.25f,0f,-3.75f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [62.5f,3.75f,0f]
...
data modify storage asa_temp: Data[23].Pose.Head set value [11.25f,-5f,-3.75f]
