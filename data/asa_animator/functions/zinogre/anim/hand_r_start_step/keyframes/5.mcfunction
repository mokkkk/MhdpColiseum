...
data modify storage asa_temp: Data[19].Pose.Head set value [130f,10f,-35f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [115f,-25f,30f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [85f,0f,-5f]
...
data modify storage asa_temp: Data[23].Pose.Head set value [15f,-5f,-5f]
