...
data modify storage asa_temp: Data[0].Pose.Head set value [-46.6875f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2985
scoreboard players set #asa_child_pos_y AsaMatrix 3877
...
data modify storage asa_temp: Data[1].Pose.Head set value [-36.6875f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2840
scoreboard players set #asa_child_pos_y AsaMatrix 3749
...
data modify storage asa_temp: Data[2].Pose.Head set value [-44.34375f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-32.34375f,34.34375f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,57.34375f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 1067
scoreboard players set #asa_child_pos_y AsaMatrix 139
...
data modify storage asa_temp: Data[17].Pose.Head set value [10.3125f,80f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [45.3125f,100.6563f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 3907
scoreboard players set #asa_child_pos_y AsaMatrix 274
scoreboard players set #asa_child_pos_z AsaMatrix -3305
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
