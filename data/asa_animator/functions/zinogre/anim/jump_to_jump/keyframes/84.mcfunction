...
data modify storage asa_temp: Data[0].Pose.Head set value [-52f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2973
scoreboard players set #asa_child_pos_y AsaMatrix 3900
...
data modify storage asa_temp: Data[1].Pose.Head set value [-42f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2841
scoreboard players set #asa_child_pos_y AsaMatrix 3751
...
data modify storage asa_temp: Data[2].Pose.Head set value [-47f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-35f,37f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,60f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 1089
scoreboard players set #asa_child_pos_y AsaMatrix 92
scoreboard players set #asa_child_pos_z AsaMatrix -2205
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[17].Pose.Head set value [5.000004f,80f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [40f,98f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 4002
