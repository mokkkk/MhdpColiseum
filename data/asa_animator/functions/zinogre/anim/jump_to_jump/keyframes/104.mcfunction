...
data modify storage asa_temp: Data[0].Pose.Head set value [-16f,-10f,10f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [-4f,-10f,10f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-6f,10f,5f]
