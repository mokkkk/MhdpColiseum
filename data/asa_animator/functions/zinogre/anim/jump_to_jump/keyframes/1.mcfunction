...
data modify storage asa_temp: Data[0].Pose.Head set value [-47f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2985
scoreboard players set #asa_child_pos_y AsaMatrix 3879
...
data modify storage asa_temp: Data[1].Pose.Head set value [-37f,44f,20f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-44.5f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-32.5f,34.5f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,57.5f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [10f,80f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [45f,100.5f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 3913
scoreboard players set #asa_child_pos_y AsaMatrix 262
scoreboard players set #asa_child_pos_z AsaMatrix -3299
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
