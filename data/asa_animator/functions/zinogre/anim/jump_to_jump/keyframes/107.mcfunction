...
data modify storage asa_temp: Data[0].Pose.Head set value [4.25f,-7.5f,5f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [10.75f,-7.5f,5f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [6.75f,7.5f,2.5f]
