...
data modify storage asa_temp: Data[0].Pose.Head set value [-51.0625f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2975
scoreboard players set #asa_child_pos_y AsaMatrix 3896
scoreboard players set #asa_child_pos_z AsaMatrix 3869
...
data modify storage asa_temp: Data[1].Pose.Head set value [-41.0625f,44f,20f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-46.53125f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-34.53125f,36.53125f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,59.53125f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [5.937502f,80f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 2293
scoreboard players set #asa_child_pos_y AsaMatrix -275
scoreboard players set #asa_child_pos_z AsaMatrix -2925
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [40.9375f,98.46875f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 3987
