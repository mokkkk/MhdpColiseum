...
data modify storage asa_temp: Data[0].Pose.Head set value [-51.6875f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2974
...
data modify storage asa_temp: Data[1].Pose.Head set value [-41.6875f,44f,20f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-46.84375f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-34.84375f,36.84375f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,59.84375f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [5.312502f,80f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [40.3125f,98.15625f,0f]
