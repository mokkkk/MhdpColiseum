...
data modify storage asa_temp: Data[0].Pose.Head set value [-2.5f,-8.333333f,6.666667f]
scoreboard players set #asa_child_pos_x AsaMatrix -1954
scoreboard players set #asa_child_pos_y AsaMatrix 1628
scoreboard players set #asa_child_pos_z AsaMatrix 5173
...
data modify storage asa_temp: Data[1].Pose.Head set value [5.833334f,-8.333334f,6.666667f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [2.5f,8.333333f,3.333333f]
