...
data modify storage asa_temp: Data[0].Pose.Head set value [-42.9375f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2994
scoreboard players set #asa_child_pos_y AsaMatrix 3861
...
data modify storage asa_temp: Data[1].Pose.Head set value [-32.9375f,44f,20f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-42.46875f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-30.46875f,32.46875f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,55.46875f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [14.0625f,80f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [49.0625f,102.5313f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 3827
