...
data modify storage asa_temp: Data[0].Pose.Head set value [-50.4375f,44f,20f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [-40.4375f,44f,20f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-46.21875f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-34.21875f,36.21875f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,59.21875f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [6.562502f,80f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [41.5625f,98.78125f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 3976
