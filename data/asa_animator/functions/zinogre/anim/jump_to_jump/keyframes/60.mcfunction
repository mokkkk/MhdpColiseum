...
data modify storage asa_temp: Data[0].Pose.Head set value [-44.5f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2990
scoreboard players set #asa_child_pos_y AsaMatrix 3868
scoreboard players set #asa_child_pos_z AsaMatrix 3880
...
data modify storage asa_temp: Data[1].Pose.Head set value [-34.5f,44f,20f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-43.25f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-31.25f,33.25f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,56.25f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,80f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [47.5f,101.75f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 3862
