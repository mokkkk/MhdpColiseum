...
data modify storage asa_temp: Data[0].Pose.Head set value [-48.875f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2981
scoreboard players set #asa_child_pos_y AsaMatrix 3887
...
data modify storage asa_temp: Data[1].Pose.Head set value [-38.875f,44f,20f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-45.4375f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-33.4375f,35.4375f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,58.4375f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [8.125f,80f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [43.125f,99.5625f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 3949
