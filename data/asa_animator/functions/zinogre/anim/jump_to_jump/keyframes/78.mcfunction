...
data modify storage asa_temp: Data[0].Pose.Head set value [-50.125f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2978
scoreboard players set #asa_child_pos_y AsaMatrix 3892
...
data modify storage asa_temp: Data[1].Pose.Head set value [-40.125f,44f,20f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-46.0625f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-34.0625f,36.0625f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,59.0625f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [6.875002f,80f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 2283
scoreboard players set #asa_child_pos_y AsaMatrix -267
scoreboard players set #asa_child_pos_z AsaMatrix -2944
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [41.875f,98.9375f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 3971
