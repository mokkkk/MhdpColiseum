...
data modify storage asa_temp: Data[0].Pose.Head set value [-51.375f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2975
scoreboard players set #asa_child_pos_y AsaMatrix 3897
...
data modify storage asa_temp: Data[1].Pose.Head set value [-41.375f,44f,20f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-46.6875f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-34.6875f,36.6875f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,59.6875f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [5.625002f,80f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [40.625f,98.3125f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 3992
