...
data modify storage asa_temp: Data[0].Pose.Head set value [-47.625f,44f,20f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [-37.625f,44f,20f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-44.8125f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-32.8125f,34.8125f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,57.8125f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [9.375f,80f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 2257
scoreboard players set #asa_child_pos_y AsaMatrix -245
scoreboard players set #asa_child_pos_z AsaMatrix -2994
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [44.375f,100.1875f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 3925
scoreboard players set #asa_child_pos_y AsaMatrix 238
scoreboard players set #asa_child_pos_z AsaMatrix -3288
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
