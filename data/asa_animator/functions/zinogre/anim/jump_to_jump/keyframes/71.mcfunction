...
data modify storage asa_temp: Data[0].Pose.Head set value [-47.9375f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2983
scoreboard players set #asa_child_pos_y AsaMatrix 3883
...
data modify storage asa_temp: Data[1].Pose.Head set value [-37.9375f,44f,20f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-44.96875f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-32.96875f,34.96875f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,57.96875f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [9.062498f,80f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [44.0625f,100.0313f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 3931
scoreboard players set #asa_child_pos_y AsaMatrix 226
