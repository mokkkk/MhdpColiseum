...
data modify storage asa_temp: Data[0].Pose.Head set value [-49.5f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2979
scoreboard players set #asa_child_pos_y AsaMatrix 3889
...
data modify storage asa_temp: Data[1].Pose.Head set value [-39.5f,44f,20f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-45.75f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-33.75f,35.75f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,58.75f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [7.5f,80f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 2277
scoreboard players set #asa_child_pos_y AsaMatrix -261
scoreboard players set #asa_child_pos_z AsaMatrix -2956
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [42.5f,99.25f,0f]
