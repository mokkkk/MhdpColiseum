...
data modify storage asa_temp: Data[0].Pose.Head set value [-43.875f,44f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2992
scoreboard players set #asa_child_pos_y AsaMatrix 3865
...
data modify storage asa_temp: Data[1].Pose.Head set value [-33.875f,44f,20f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-42.9375f,44f,10f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-30.9375f,32.9375f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-15f,55.9375f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [13.125f,80f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [48.125f,102.0625f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 3848
