...
data modify storage asa_temp: Data[0].Pose.Head set value [35f,10f,-30f]
scoreboard players set #asa_child_pos_x AsaMatrix 3399
scoreboard players set #asa_child_pos_y AsaMatrix 1826
...
data modify storage asa_temp: Data[1].Pose.Head set value [45f,10f,-30f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [45f,-20f,-40f]
...
data modify storage asa_temp: Data[3].Pose.Head set value [50f,-20f,-40f]
...
data modify storage asa_temp: Data[4].Pose.Head set value [40f,-30f,-40f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [130f,-10f,-40f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [110f,-50f,60f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [95f,-60f,-20f]
scoreboard players set #asa_child_pos_x AsaMatrix 3660
...
data modify storage asa_temp: Data[23].Pose.Head set value [20f,-65f,-20f]
scoreboard players set #asa_child_pos_x AsaMatrix 4522
...
scoreboard players set #asa_child_pos_x AsaMatrix -930
scoreboard players set #asa_child_pos_y AsaMatrix -858
scoreboard players set #asa_child_pos_z AsaMatrix 3831
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
