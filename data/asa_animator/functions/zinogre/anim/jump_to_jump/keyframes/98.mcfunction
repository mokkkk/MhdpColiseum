...
data modify storage asa_temp: Data[0].Pose.Head set value [-23.5f,-13f,30f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [1.5f,-13f,30f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-28.5f,7f,15f]
