...
data modify storage asa_temp: Data[0].Pose.Head set value [-26.4f,21.2f,24f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [-10.4f,21.2f,24f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-33.4f,29.2f,12f]
scoreboard players set #asa_child_pos_x AsaMatrix -2752
scoreboard players set #asa_child_pos_y AsaMatrix 3359
scoreboard players set #asa_child_pos_z AsaMatrix 3660
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[3].Pose.Head set value [-11.4f,35.2f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -2470
scoreboard players set #asa_child_pos_y AsaMatrix 3260
...
data modify storage asa_temp: Data[4].Pose.Head set value [-5.4f,41.2f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -2270
scoreboard players set #asa_child_pos_y AsaMatrix 3282
...
data modify storage asa_temp: Data[5].Pose.Head set value [9.200001f,43.2f,0f]
...
data modify storage asa_temp: Data[6].Pose.Head set value [-8f,23.2f,0f]
...
data modify storage asa_temp: Data[7].Pose.Head set value [-14f,21.6f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [12f,17.6f,10f]
scoreboard players set #asa_child_pos_x AsaMatrix -989
scoreboard players set #asa_child_pos_y AsaMatrix 689
scoreboard players set #asa_child_pos_z AsaMatrix -486
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[9].Pose.Head set value [80f,21.6f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [90f,25.6f,10f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [28f,13.6f,-10f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [14f,25.6f,10f]
...
data modify storage asa_temp: Data[13].Pose.Head set value [8f,-2.4f,0f]
...
data modify storage asa_temp: Data[14].Pose.Head set value [0f,41.6f,0f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-25f,24.6f,0f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-5f,27f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [3f,32f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 1702
scoreboard players set #asa_child_pos_y AsaMatrix 203
scoreboard players set #asa_child_pos_z AsaMatrix -3661
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [18f,35.4f,0f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [95.2f,61.2f,-22f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [119.2f,33.2f,50f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [49.2f,19.2f,-8f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [91.2f,67.2f,28f]
...
data modify storage asa_temp: Data[23].Pose.Head set value [-0.7999992f,14.2f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 103
scoreboard players set #asa_child_pos_y AsaMatrix -867
scoreboard players set #asa_child_pos_z AsaMatrix 4619
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[24].Pose.Head set value [1.199997f,72.2f,12f]
scoreboard players set #asa_child_pos_x AsaMatrix -4540
