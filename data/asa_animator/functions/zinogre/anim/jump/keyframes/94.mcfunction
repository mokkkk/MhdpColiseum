...
data modify storage asa_temp: Data[0].Pose.Head set value [24.08333f,-9.166667f,8.333333f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [34.25f,-9.166662f,8.333333f]
scoreboard players set #asa_child_pos_x AsaMatrix -2130
scoreboard players set #asa_child_pos_y AsaMatrix 1880
scoreboard players set #asa_child_pos_z AsaMatrix 4929
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[2].Pose.Head set value [6.583333f,9.166667f,4.166667f]
