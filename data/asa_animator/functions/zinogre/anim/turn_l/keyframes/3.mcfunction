...
data modify storage asa_temp: Data[0].Pose.Head set value [17.5f,-15f,2.5f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [17.5f,-15f,2.5f]
scoreboard players set #asa_child_pos_x AsaMatrix 284
scoreboard players set #asa_child_pos_y AsaMatrix 3673
...
data modify storage asa_temp: Data[2].Pose.Head set value [7.5f,-15f,2.5f]
...
data modify storage asa_temp: Data[3].Pose.Head set value [2.5f,-10f,2.5f]
...
data modify storage asa_temp: Data[4].Pose.Head set value [-7.5f,-5f,2.5f]
...
data modify storage asa_temp: Data[5].Pose.Head set value [-7.5f,-2.5f,0f]
...
data modify storage asa_temp: Data[13].Pose.Head set value [20f,0f,0f]
...
scoreboard players set #asa_child_pos_z AsaMatrix -5600
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[19].Pose.Head set value [112.5f,7.5f,-30f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [107.5f,-12.5f,30f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [57.5f,-2.5f,0f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [72.5f,2.5f,0f]
...
data modify storage asa_temp: Data[23].Pose.Head set value [2.5f,-7.5f,0f]
