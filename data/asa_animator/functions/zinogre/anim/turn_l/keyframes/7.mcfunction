...
data modify storage asa_temp: Data[10].Pose.Head set value [82.5f,0f,10f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [110f,0f,-20f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [45f,-10f,0f]
...
data modify storage asa_temp: Data[23].Pose.Head set value [2.5f,-15f,0f]
