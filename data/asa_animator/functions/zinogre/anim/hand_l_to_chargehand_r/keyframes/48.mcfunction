...
data modify storage asa_temp: Data[12].Pose.Head set value [35f,-20f,10f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [120f,-80f,50f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [45f,-50f,0f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [75f,-10f,0f]
