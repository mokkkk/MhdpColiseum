...
data modify storage asa_temp: Data[0].Pose.Head set value [-66.66666f,50.66666f,-20f]
...
data modify storage asa_temp: Data[1].Pose.Head set value [-29.66667f,50.66666f,-20f]
scoreboard players set #asa_child_pos_x AsaMatrix -3477
scoreboard players set #asa_child_pos_y AsaMatrix 3369
...
data modify storage asa_temp: Data[2].Pose.Head set value [-46f,50.66666f,-20f]
...
data modify storage asa_temp: Data[3].Pose.Head set value [-29.66667f,50.66666f,-20f]
...
data modify storage asa_temp: Data[4].Pose.Head set value [-40f,50.66666f,-20f]
...
data modify storage asa_temp: Data[5].Pose.Head set value [-5f,30.66667f,-20f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-40f,30f,-10f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-21.66667f,7.666666f,-10f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [1.666668f,-23.66667f,-10f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [23.33333f,-53.66667f,-10f]
scoreboard players set #asa_child_pos_x AsaMatrix 916
scoreboard players set #asa_child_pos_y AsaMatrix -2
scoreboard players set #asa_child_pos_z AsaMatrix -5036
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[19].Pose.Head set value [60f,67.33334f,-60f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [106.6667f,20.66667f,50f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [60f,0.6666718f,-10f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [55f,20.66667f,-5f]
...
data modify storage asa_temp: Data[23].Pose.Head set value [0f,-4.33333f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 529
scoreboard players set #asa_child_pos_y AsaMatrix -712
scoreboard players set #asa_child_pos_z AsaMatrix 4617
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[24].Pose.Head set value [-2.333332f,25.66667f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix -4338
