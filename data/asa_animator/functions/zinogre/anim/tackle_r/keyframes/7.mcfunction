...
data modify storage asa_temp: Data[0].Pose.Head set value [-31.25f,18.75f,-11.25f]
scoreboard players set #asa_child_pos_x AsaMatrix -499
scoreboard players set #asa_child_pos_y AsaMatrix 3756
scoreboard players set #asa_child_pos_z AsaMatrix 4879
...
data modify storage asa_temp: Data[1].Pose.Head set value [-8.75f,18.75f,-11.25f]
scoreboard players set #asa_child_pos_x AsaMatrix -414
scoreboard players set #asa_child_pos_y AsaMatrix 3773
...
data modify storage asa_temp: Data[2].Pose.Head set value [-26.25f,11.25f,-11.25f]
scoreboard players set #asa_child_pos_x AsaMatrix -375
scoreboard players set #asa_child_pos_y AsaMatrix 3715
...
data modify storage asa_temp: Data[3].Pose.Head set value [-16.25f,7.5f,-11.25f]
...
data modify storage asa_temp: Data[4].Pose.Head set value [-26.25f,3.75f,-11.25f]
...
data modify storage asa_temp: Data[5].Pose.Head set value [-1.25f,0f,-11.25f]
...
data modify storage asa_temp: Data[6].Pose.Head set value [0f,-7.5f,0f]
...
data modify storage asa_temp: Data[7].Pose.Head set value [10f,-7.5f,-21.25f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [10f,-15f,13.75f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [80f,-7.5f,-21.25f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [80f,-18.75f,13.75f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [-5.625f,-7.5f,-17.5f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-30f,3.75f,-7.5f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [-17.5f,-7.5f,-7.5f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [0f,-18.75f,-7.5f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [18.75f,-30f,-7.5f]
...
data modify storage asa_temp: Data[19].Pose.Head set value [106.25f,21.25f,-30f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [102.5f,-10f,71.25f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [64.375f,3.75f,0f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [55f,22.5f,-3.75f]
...
data modify storage asa_temp: Data[23].Pose.Head set value [-7.5f,-1.25f,0f]
...
data modify storage asa_temp: Data[24].Pose.Head set value [22.5f,27.5f,0f]
