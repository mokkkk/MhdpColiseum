...
data modify storage asa_temp: Data[0].Pose.Head set value [3f,10f,-8f]
scoreboard players set #asa_child_pos_x AsaMatrix 44
scoreboard players set #asa_child_pos_y AsaMatrix 1940
scoreboard players set #asa_child_pos_z AsaMatrix 5520
...
data modify storage asa_temp: Data[1].Pose.Head set value [9f,10f,-8f]
...
data modify storage asa_temp: Data[2].Pose.Head set value [-7f,4f,-4f]
...
data modify storage asa_temp: Data[3].Pose.Head set value [12f,4f,0f]
...
data modify storage asa_temp: Data[4].Pose.Head set value [32f,-2f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 101
scoreboard players set #asa_child_pos_y AsaMatrix 2379
...
data modify storage asa_temp: Data[5].Pose.Head set value [21f,-2f,0f]
...
data modify storage asa_temp: Data[6].Pose.Head set value [6.8f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[7].Pose.Head set value [23.6f,0f,-10f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [18f,0f,10f]
scoreboard players set #asa_child_pos_x AsaMatrix -1100
scoreboard players set #asa_child_pos_y AsaMatrix 713
scoreboard players set #asa_child_pos_z AsaMatrix -135
function #asa_matrix:rotate_world
...
data modify storage asa_temp: Data[9].Pose.Head set value [93.4f,0f,-10f]
...
data modify storage asa_temp: Data[10].Pose.Head set value [103f,0f,10f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [17.40001f,0f,-10f]
...
data modify storage asa_temp: Data[12].Pose.Head set value [18f,0f,10f]
...
data modify storage asa_temp: Data[13].Pose.Head set value [-0.3999977f,0f,0f]
...
data modify storage asa_temp: Data[14].Pose.Head set value [-0.3999996f,20f,0f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-23.2f,-10f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[16].Pose.Head set value [-10.2f,5f,0f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [3.8f,25f,0f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [22.8f,35f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 661
scoreboard players set #asa_child_pos_y AsaMatrix 809
scoreboard players set #asa_child_pos_z AsaMatrix -5588
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[19].Pose.Head set value [130f,8f,-45f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [130f,-4f,46f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [49f,-16f,-3f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [66.4f,16f,20f]
scoreboard players set #asa_child_pos_x AsaMatrix -2539
scoreboard players set #asa_child_pos_y AsaMatrix 807
scoreboard players set #asa_child_pos_z AsaMatrix 1558
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[23].Pose.Head set value [0f,-21f,0f]
...
data modify storage asa_temp: Data[24].Pose.Head set value [0.8000031f,21f,0f]
