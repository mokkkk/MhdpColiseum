...
data modify storage asa_temp: Data[17].Pose.Head set value [-15f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[18].Pose.Head set value [0f,0f,0f]
scoreboard players set #asa_child_pos_x AsaMatrix 0
...
data modify storage asa_temp: Data[22].Pose.Head set value [70f,0f,0f]
