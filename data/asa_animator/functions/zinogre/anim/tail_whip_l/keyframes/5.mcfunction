...
data modify storage asa_temp: Data[7].Pose.Head set value [12.5f,-10f,-10f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [80.5f,-10f,-10f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [7f,-10f,-10f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [109f,-10f,30f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [61.5f,0f,0f]
...
data modify storage asa_temp: Data[24].Pose.Head set value [19f,5f,-5f]
scoreboard players set #asa_child_pos_x AsaMatrix -2246
