...
scoreboard players set #asa_child_pos_x AsaMatrix -3688
...
scoreboard players set #asa_child_pos_x AsaMatrix -5281
...
data modify storage asa_temp: Data[19].Pose.Head set value [140f,-36f,-25f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [115f,-55f,50f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [88f,-98f,-10f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [65f,-5f,10f]
