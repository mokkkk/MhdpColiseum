...
data modify storage asa_temp: Data[19].Pose.Head set value [120f,40f,-30f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [150f,-10f,40f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [100f,0f,10f]
...
data modify storage asa_temp: Data[24].Pose.Head set value [30f,5f,10f]
