...
data modify storage asa_temp: Data[19].Pose.Head set value [112.5f,17.5f,-30f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [120f,-10f,32.5f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [65f,-2.5f,0f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [77.5f,0f,2.5f]
...
data modify storage asa_temp: Data[24].Pose.Head set value [7.5f,5f,2.5f]
