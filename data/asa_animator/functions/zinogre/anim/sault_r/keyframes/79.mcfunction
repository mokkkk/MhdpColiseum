...
data modify storage asa_temp: Data[1].Pose.Head set value [71f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,30f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,60f,375f]
scoreboard players set #asa_child_pos_x AsaMatrix 1186
scoreboard players set #asa_child_pos_y AsaMatrix 733
scoreboard players set #asa_child_pos_z AsaMatrix -2363
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,75f,365f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,110f,355f]
scoreboard players set #asa_child_pos_x AsaMatrix 4108
scoreboard players set #asa_child_pos_y AsaMatrix 1276
scoreboard players set #asa_child_pos_z AsaMatrix -3486
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
