...
data modify storage asa_temp: Data[1].Pose.Head set value [75.85294f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,23.52941f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,47.05882f,375f]
scoreboard players set #asa_child_pos_x AsaMatrix 1071
scoreboard players set #asa_child_pos_y AsaMatrix 764
scoreboard players set #asa_child_pos_z AsaMatrix -2423
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,55.58823f,365f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,84.11765f,355f]
scoreboard players set #asa_child_pos_x AsaMatrix 3581
