...
data modify storage asa_temp: Data[1].Pose.Head set value [75.41177f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,24.11765f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,48.23529f,375f]
scoreboard players set #asa_child_pos_x AsaMatrix 1082
scoreboard players set #asa_child_pos_y AsaMatrix 761
scoreboard players set #asa_child_pos_z AsaMatrix -2418
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,57.35294f,365f]
scoreboard players set #asa_child_pos_x AsaMatrix 2191
scoreboard players set #asa_child_pos_y AsaMatrix 915
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,86.47059f,355f]
