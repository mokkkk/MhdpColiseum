...
data modify storage asa_temp: Data[1].Pose.Head set value [73.20589f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,27.05882f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,54.11765f,375f]
scoreboard players set #asa_child_pos_x AsaMatrix 1135
scoreboard players set #asa_child_pos_y AsaMatrix 747
scoreboard players set #asa_child_pos_z AsaMatrix -2392
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,66.17648f,365f]
scoreboard players set #asa_child_pos_x AsaMatrix 2330
scoreboard players set #asa_child_pos_y AsaMatrix 878
scoreboard players set #asa_child_pos_z AsaMatrix -3203
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,98.23529f,355f]
scoreboard players set #asa_child_pos_x AsaMatrix 3898
scoreboard players set #asa_child_pos_y AsaMatrix 1317
