...
data modify storage asa_temp: Data[1].Pose.Head set value [74.08823f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,25.88235f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,51.76471f,375f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,62.64706f,365f]
scoreboard players set #asa_child_pos_x AsaMatrix 2276
scoreboard players set #asa_child_pos_y AsaMatrix 892
scoreboard players set #asa_child_pos_z AsaMatrix -3259
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,93.52941f,355f]
scoreboard players set #asa_child_pos_x AsaMatrix 3799
scoreboard players set #asa_child_pos_y AsaMatrix 1335
