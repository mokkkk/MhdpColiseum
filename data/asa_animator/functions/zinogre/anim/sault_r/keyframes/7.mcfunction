...
data modify storage asa_temp: Data[19].Pose.Head set value [102.5f,40f,-45f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [117.5f,20f,37.5f]
...
data modify storage asa_temp: Data[21].Pose.Head set value [43.75f,0f,-7.5f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [73.75f,60f,15f]
...
data modify storage asa_temp: Data[24].Pose.Head set value [15f,65f,15f]
scoreboard players set #asa_child_pos_x AsaMatrix -4685
