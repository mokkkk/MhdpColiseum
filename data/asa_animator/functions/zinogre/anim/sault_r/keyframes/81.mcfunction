...
data modify storage asa_temp: Data[1].Pose.Head set value [71.88235f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,28.82353f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,57.64706f,375f]
scoreboard players set #asa_child_pos_x AsaMatrix 1166
scoreboard players set #asa_child_pos_y AsaMatrix 738
scoreboard players set #asa_child_pos_z AsaMatrix -2375
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,71.47059f,365f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,105.2941f,355f]
scoreboard players set #asa_child_pos_x AsaMatrix 4030
scoreboard players set #asa_child_pos_y AsaMatrix 1291
scoreboard players set #asa_child_pos_z AsaMatrix -3644
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
