...
data modify storage asa_temp: Data[7].Pose.Head set value [20f,17.5f,325f]
...
data modify storage asa_temp: Data[8].Pose.Head set value [10f,17.5f,375f]
...
data modify storage asa_temp: Data[9].Pose.Head set value [95f,17.5f,325f]
...
data modify storage asa_temp: Data[11].Pose.Head set value [15f,17.5f,325f]
...
data modify storage asa_temp: Data[13].Pose.Head set value [0f,17.5f,355f]
...
data modify storage asa_temp: Data[14].Pose.Head set value [0f,17.5f,365f]
...
scoreboard players set #asa_child_pos_x AsaMatrix -4173
