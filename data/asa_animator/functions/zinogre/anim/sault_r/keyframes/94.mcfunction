...
data modify storage asa_temp: Data[1].Pose.Head set value [77.61765f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,21.17647f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,42.35294f,375f]
scoreboard players set #asa_child_pos_x AsaMatrix 1028
scoreboard players set #asa_child_pos_y AsaMatrix 775
scoreboard players set #asa_child_pos_z AsaMatrix -2442
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,48.52941f,365f]
scoreboard players set #asa_child_pos_x AsaMatrix 2041
scoreboard players set #asa_child_pos_y AsaMatrix 955
scoreboard players set #asa_child_pos_z AsaMatrix -3464
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,74.70588f,355f]
scoreboard players set #asa_child_pos_x AsaMatrix 3334
scoreboard players set #asa_child_pos_y AsaMatrix 1418
scoreboard players set #asa_child_pos_z AsaMatrix -4567
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
