...
data modify storage asa_temp: Data[1].Pose.Head set value [78.5f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,20f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,40f,375f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,45f,365f]
scoreboard players set #asa_child_pos_x AsaMatrix 1977
scoreboard players set #asa_child_pos_y AsaMatrix 972
...
scoreboard players set #asa_child_pos_y AsaMatrix 1441
scoreboard players set #asa_child_pos_z AsaMatrix -4687
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
