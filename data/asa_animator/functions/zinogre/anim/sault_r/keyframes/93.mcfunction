...
data modify storage asa_temp: Data[1].Pose.Head set value [77.17647f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,21.76471f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,43.52941f,375f]
scoreboard players set #asa_child_pos_x AsaMatrix 1039
scoreboard players set #asa_child_pos_y AsaMatrix 772
scoreboard players set #asa_child_pos_z AsaMatrix -2437
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,50.29411f,365f]
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,77.05882f,355f]
scoreboard players set #asa_child_pos_x AsaMatrix 3398
scoreboard players set #asa_child_pos_y AsaMatrix 1407
scoreboard players set #asa_child_pos_z AsaMatrix -4504
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
