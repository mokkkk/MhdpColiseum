...
data modify storage asa_temp: Data[1].Pose.Head set value [76.29411f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,22.94118f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,45.88235f,375f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,53.82352f,365f]
scoreboard players set #asa_child_pos_x AsaMatrix 2132
scoreboard players set #asa_child_pos_y AsaMatrix 931
scoreboard players set #asa_child_pos_z AsaMatrix -3391
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,81.7647f,355f]
