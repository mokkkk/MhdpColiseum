...
data modify storage asa_temp: Data[1].Pose.Head set value [72.76471f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,27.64706f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,55.29412f,375f]
scoreboard players set #asa_child_pos_x AsaMatrix 1145
scoreboard players set #asa_child_pos_y AsaMatrix 744
scoreboard players set #asa_child_pos_z AsaMatrix -2387
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,67.94118f,365f]
scoreboard players set #asa_child_pos_x AsaMatrix 2356
scoreboard players set #asa_child_pos_y AsaMatrix 871
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,100.5882f,355f]
scoreboard players set #asa_child_pos_x AsaMatrix 3944
scoreboard players set #asa_child_pos_y AsaMatrix 1308
scoreboard players set #asa_child_pos_z AsaMatrix -3799
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
