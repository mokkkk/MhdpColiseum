...
data modify storage asa_temp: Data[1].Pose.Head set value [71.44118f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,29.41176f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,58.82353f,375f]
scoreboard players set #asa_child_pos_x AsaMatrix 1176
scoreboard players set #asa_child_pos_y AsaMatrix 736
scoreboard players set #asa_child_pos_z AsaMatrix -2369
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,73.23529f,365f]
scoreboard players set #asa_child_pos_x AsaMatrix 2432
scoreboard players set #asa_child_pos_y AsaMatrix 850
scoreboard players set #asa_child_pos_z AsaMatrix -3085
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,107.6471f,355f]
scoreboard players set #asa_child_pos_x AsaMatrix 4070
scoreboard players set #asa_child_pos_y AsaMatrix 1283
scoreboard players set #asa_child_pos_z AsaMatrix -3566
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
