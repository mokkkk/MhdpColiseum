...
scoreboard players set #asa_child_pos_x AsaMatrix -2140
...
scoreboard players set #asa_child_pos_x AsaMatrix -1596
...
scoreboard players set #asa_child_pos_x AsaMatrix 3073
...
data modify storage asa_temp: Data[19].Pose.Head set value [103.75f,35f,-42.5f]
...
data modify storage asa_temp: Data[20].Pose.Head set value [116.25f,15f,36.25f]
scoreboard players set #asa_child_pos_x AsaMatrix -2074
...
data modify storage asa_temp: Data[21].Pose.Head set value [48.125f,0f,-6.25f]
...
data modify storage asa_temp: Data[22].Pose.Head set value [73.125f,50f,12.5f]
...
data modify storage asa_temp: Data[24].Pose.Head set value [12.5f,55f,12.5f]
scoreboard players set #asa_child_pos_x AsaMatrix -4430
