...
data modify storage asa_temp: Data[1].Pose.Head set value [78.05882f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,20.58823f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,41.17647f,375f]
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,46.7647f,365f]
scoreboard players set #asa_child_pos_x AsaMatrix 2009
scoreboard players set #asa_child_pos_y AsaMatrix 964
scoreboard players set #asa_child_pos_z AsaMatrix -3487
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,72.35294f,355f]
scoreboard players set #asa_child_pos_x AsaMatrix 3268
