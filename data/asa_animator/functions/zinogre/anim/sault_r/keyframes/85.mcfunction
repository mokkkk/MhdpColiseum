...
data modify storage asa_temp: Data[1].Pose.Head set value [73.64706f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,26.47059f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,52.94118f,375f]
scoreboard players set #asa_child_pos_x AsaMatrix 1124
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,64.41177f,365f]
scoreboard players set #asa_child_pos_x AsaMatrix 2303
scoreboard players set #asa_child_pos_y AsaMatrix 885
scoreboard players set #asa_child_pos_z AsaMatrix -3231
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,95.88235f,355f]
scoreboard players set #asa_child_pos_x AsaMatrix 3849
scoreboard players set #asa_child_pos_y AsaMatrix 1326
scoreboard players set #asa_child_pos_z AsaMatrix -3950
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
