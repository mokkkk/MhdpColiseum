...
data modify storage asa_temp: Data[1].Pose.Head set value [76.73529f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,22.35294f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,44.70588f,375f]
scoreboard players set #asa_child_pos_x AsaMatrix 1050
scoreboard players set #asa_child_pos_y AsaMatrix 769
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,52.05882f,365f]
scoreboard players set #asa_child_pos_x AsaMatrix 2102
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,79.41176f,355f]
scoreboard players set #asa_child_pos_x AsaMatrix 3461
scoreboard players set #asa_child_pos_y AsaMatrix 1396
scoreboard players set #asa_child_pos_z AsaMatrix -4440
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
