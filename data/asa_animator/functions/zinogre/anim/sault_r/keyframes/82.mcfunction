...
data modify storage asa_temp: Data[1].Pose.Head set value [72.32353f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,28.23529f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,56.47059f,375f]
scoreboard players set #asa_child_pos_x AsaMatrix 1156
scoreboard players set #asa_child_pos_y AsaMatrix 741
scoreboard players set #asa_child_pos_z AsaMatrix -2381
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,69.70589f,365f]
scoreboard players set #asa_child_pos_x AsaMatrix 2382
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,102.9412f,355f]
scoreboard players set #asa_child_pos_x AsaMatrix 3988
scoreboard players set #asa_child_pos_y AsaMatrix 1300
scoreboard players set #asa_child_pos_z AsaMatrix -3722
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
