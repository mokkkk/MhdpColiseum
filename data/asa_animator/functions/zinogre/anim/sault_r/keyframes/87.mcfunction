...
data modify storage asa_temp: Data[1].Pose.Head set value [74.52941f,-10f,380f]
...
data modify storage asa_temp: Data[15].Pose.Head set value [-12.5f,25.29412f,375f]
...
data modify storage asa_temp: Data[16].Pose.Head set value [17.5f,50.58823f,375f]
scoreboard players set #asa_child_pos_x AsaMatrix 1103
scoreboard players set #asa_child_pos_y AsaMatrix 755
scoreboard players set #asa_child_pos_z AsaMatrix -2408
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[17].Pose.Head set value [12.5f,60.88235f,365f]
scoreboard players set #asa_child_pos_x AsaMatrix 2248
scoreboard players set #asa_child_pos_y AsaMatrix 900
scoreboard players set #asa_child_pos_z AsaMatrix -3286
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
...
data modify storage asa_temp: Data[18].Pose.Head set value [17.5f,91.17647f,355f]
scoreboard players set #asa_child_pos_x AsaMatrix 3747
scoreboard players set #asa_child_pos_y AsaMatrix 1345
scoreboard players set #asa_child_pos_z AsaMatrix -4097
function #asa_matrix:rotate_world
function #asa_matrix:get_child_pos
