#> asa_animator:reus/manager/3_damage/check
#
# 火竜 ダメージ量確認
...
# ダメージ0.5以下なら無効
execute unless score #reus_damage AsaMatrix matches -251.. at @s run function asa_animator:reus/manager/3_damage/damage
