...
# HPセット
    ...
    # マルチ補正計算
        ...
        scoreboard players operation #mhdp_diablos_health AsaMatrix *= #mhdp_const_temp_0 AsaMatrix
    # 代入
        execute store result score #mhdp_diablos_health_half AsaMatrix store result score #mhdp_diablos_head_damage AsaMatrix store result score #mhdp_diablos_body_damage AsaMatrix store result score #mhdp_diablos_tail_damage AsaMatrix store result score #mhdp_diablos_anger_damage_max AsaMatrix store result score #mhdp_diablos_anger_damage_max AsaMatrix run scoreboard players operation #mhdp_diablos_health AsaMatrix /= #asam_const_100 AsaMatrix
    # 体力半分取得
        scoreboard players set #mhdp_const_temp AsaMatrix 2
        scoreboard players operation #mhdp_diablos_health_half AsaMatrix /= #mhdp_const_temp AsaMatrix
